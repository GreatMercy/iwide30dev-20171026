            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                	<div class="row">
	                	<div class="col-md-12">
	                	<?php echo form_open(site_url('distribute/send_records/saler_logs/').'?bn='.$batch_no,'class="form-inline"')?>
                  ...
                  <div class="row">
                  <div class="col-sm-5">
                  <div class="dataTables_info" id="data-grid_info" role="status" aria-live="polite"><a href="<?php echo site_url('distribute/send_records/ext_saler_logs/'.$saler_no.'_'.$saler_name.'_'.$msg_typ.'_'.$batch_no);?>" class="btn btn-default">导出</a></div>
                  </div>
