...
<!-- Logo -->
    ...
    <div class="user-panel dropdown" style="float:left; width:200px; text-align:center; cursor:pointer; overflow:visible;   border-bottom: 1px solid #d7e0f1;height: 52px;">
...
<!-- Control Sidebar Toggle Button -->
    ...
    <style type="text/css">
        ...
        .j_toshow{width:320px;min-height:100%;position:fixed;top:0px !important;right:-330px;box-shadow:-5px 0px 15px rgba(0,0,0,0.1);-webkit-box-shadow:-5px 0px 15px rgba(0,0,0,0.1);z-index:9999;}
