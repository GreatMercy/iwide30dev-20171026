...
<form action="sresult?id=<?php echo $inter_id?>&type=<?php echo $type?>" onsubmit="$(this).attr('action', $(this).attr('action')+'&city='+escape($('#city').val()))" method="post">
...
<div class="vote_spread bg_fff">
	...
	<a href="<?php echo $fa['ad_link'];?>"><img src="<?php echo $fa['ad_img'];?>" info="<?php echo $fa['ad_title'];?>"/></a>
	<?php }}?>
</div>  
<script>
$(function(){
