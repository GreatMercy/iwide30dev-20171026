		...
		<div class="content-wrapper">
			...
			<section class="content">
                ...
                <!-- 编辑二维码弹层 -->
				    ...
				    <?php 
	echo form_open( EA_const_url::inst()->get_url('*/*/edit_post'), array('class'=>'form-horizontal') ); ?>
						<input type="hidden" name="key" id="key" value="" />
									<div class="form-group ">
										<label class="col-sm-3 control-label">酒店</label>
										<div class="col-sm-8">
											<select class="form-control" name="hotel" id="hotel">
											<?php foreach ($hotels as $hotel):?><option value="<?php echo $hotel['name']?>"><?php echo $hotel['name']?></option>
											<?php endforeach;?>
											</select>
										</div>
									</div>
