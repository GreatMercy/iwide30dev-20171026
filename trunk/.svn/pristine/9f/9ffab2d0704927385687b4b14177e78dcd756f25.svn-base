                ...
                <div class="img_bg_1 webkitbox pad_tb60 pad_l40 boxflex">
                    <div class="pad_r20" style="width:calc(100% - 90px);">
                        ...
                        <p class="color2 h24">
                            ...
                            <a  href="javascript:tonavigate(<?php echo $order['latitude'];?>,<?php echo $order['longitude'];?>,'<?php echo $order['hname'];?>','<?php echo $order['haddress'];?>')" ><?php echo $order['haddress'];?></a> 
                        </p>
                    </div> 
            ...
            <div class="mar_b80">
                ...
                <div class="commodity_rows border_radius layer_bg mar_b30">
                    ...
                    <div class="commodity_img_content">
                        ...
                        <div>
                            <span class="color3 commodity_details_ico h26 commodity_details_ico">详情 <i class="iconfont package_detail_ico">&#Xe013;</i></span>
            ...
            <div class="pad_b20 mar_b30 relative">
                ...
                <div class="color2">
                    <div class="webkitbox mar_b30">
                        <p class="word_list_left color2 h28 flex between">
                            <span class="block">订</span>
                            <span class="block">单</span>
                            <span class="block">编</span>
                    ...
                    <div class="webkitbox mar_b30">
                        <p class="word_list_left color2 h28 flex between">
                            <span class="block">支</span>
                            <span class="block">付</span>
                            <span class="block">类</span>
                            <span class="block">型</span>
                        </p>
                        <p class="color1 h30 from_list_word"><?php echo $pay_ways[$order['paytype']]->pay_name;?></p>
                    </div>
                    <div class="webkitbox mar_b30">
                        <p class="word_list_left color2 h28 flex between">
                            <span class="block">下</span>
                            <span class="block">单</span>
                            <span class="block">时</span>
                            <span class="block">间</span>
                        </p>
                        <p class="color1 h30 from_list_word"><?php echo date('y/m/d H:i:s',$order['order_time']);?></p>
                    </div>
                    <div class="webkitbox mar_b30">
                        <p class="word_list_left color2 h28 flex between">
                            <span class="block">优</span>
                            <span class="block">惠</span>
                    ...
                    <?php if($order['wxpay_favour']>0){ ?>
                        <div class="webkitbox">
                            <p class="word_list_left color2 h28 flex between">
                                <span class="block">支</span>
                                <span class="block">付</span>
                                <span class="block">立</span>
                                <span class="block">减</span>
                            </p>                         
                    ...
                    <div class="webkitbox mar_b30">
                        <p class="word_list_left color2 h28 flex between">
                            <span class="block">房</span>
                            <span class="block">间</span>
                            <span class="block">数</span>
                        </p> 
                        <p class="color1 h30 from_list_word"><?php echo $order['roomnums'];?>间</p>
                    </div>
                    <div class="webkitbox mar_b30">
                        <p class="word_list_left color2 h28 flex between">
                            <span class="block">实</span>
                            <span class="block">付</span>
                            <span class="block">总</span>
                            <span class="block">额</span>
                        </p> 
                        <p class="color1 h30 from_list_word"><?php echo $order['paytype']=='point'?0:$order['price'];?></p>
                    </div>
                    <div class="webkitbox mar_b30">
                        <p class="word_list_left color2 h28 flex between">
                            <span class="block">备</span>
                            <span class="block">注</span>
                        </p> 
