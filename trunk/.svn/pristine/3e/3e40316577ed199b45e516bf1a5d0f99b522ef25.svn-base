      	...
      	<div class="li_con">
            ...
            <?php if(isset($give_rule)&&!empty($give_rule)){
                        if(isset($give_rule->all)){   ?>
                            <span>全部会员  消费<?php echo $give_rule->all->cost;?>元送<?php echo $give_rule->all->amount;?></span><br>
                <?php  }else{
                            foreach($give_rule as $key=>$arr){  ?>
                            <span><?php echo $levels[$key]?>  消费<?php echo $give_rule->$key->cost;?>元送<?php echo $give_rule->$key->amount;?></span><br>
                <?php       }
                        }
                }
             ?>
