                ...
                <table class="new_tabels"  style="width:100%;">
                  ...
                  <?php foreach($years as $key=>$year){ ?>
                    <tr class="form_con">
                      ...
                      <td><?php echo $year['night'];?></td>
                      <td><?php if(isset($all_years[$key]['night']) && $all_years[$key]['night']!=0)echo round($year['night']/$all_years[$key]['night'],2)*100;else echo 0;?>%</td>
                      <td><?php echo $year['total_price'];?></td>
                      <td><?php if(isset($all_years[$key]['total_price']) && $all_years[$key]['total_price']!=0)echo round($year['total_price']/$all_years[$key]['total_price'],2)*100;else echo 0;?>%</td>
                      <td class=""><?php if(isset($year['count']) && $year['count']!=0)echo round($year['night']/$year['count'],2)*100;else echo 0;?>%</td>
                      ...
                      <td class=""><?php if($key!=11 && $year['total_price']!=0)echo round(($year['total_price']-$years[$key+1]['total_price'])/$year['total_price'],2)*100;else echo 0;?>%</td>
                    </tr>
                  <?php }?>
<!--                    <tr class="form_con">-->
<!--                      <td class="b_r_1"></td>-->
                  ...
                  <tbody class="containers dataTables_wrapper form-inline dt-bootstrap  color_555">
                    <?php if(!empty($club)){ foreach($club as $arr){ ?>
                        <tr class="form_con">
                          ...
                          <td><?php if(isset($arr['total_price']) && isset($arr['night']))echo $arr['total_price']/$arr['night'];else echo 0;?></td>
                          <td class=""><?php if(isset($arr['total_price']))echo $arr['total_price'];else echo 0;?></td>
                          <td class="">¥<?php if(isset($garde[$arr['club_id']]))echo $garde[$arr['club_id']]['grade_total'];else echo 0;?></td>
                    </tr>
                    <?php }}?>
                  </tbody>
                </table>
...
//              },
              ...
              series : [
                  ...
                  },
                  {
                      ...
                      smooth:true,
                      itemStyle: {normal: {areaStyle: {type: 'default'}}},
                      data:[<?php foreach(array_reverse($years) AS $key=>$year){ echo '\''.$year['night'].'\',';}?>]
                  },
                  {
                      name:'收入',
                      type:'line',
                      smooth:true,
                      itemStyle: {normal: {areaStyle: {type: 'default'}}},
                      data:[<?php foreach(array_reverse($years) AS $key=>$year){ echo '\''.$year['total_price'].'\',';}?>]
                  }
              ]
          };
