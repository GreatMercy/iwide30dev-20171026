            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                	<div class="row">
	                	<div class="col-md-12">
	                		<?php echo form_open(site_url('distribute/send_records/batch_log/'),'class="form-inline"')?>
	                	...
	                	<div class="col-md-12">
		                    ...
		                    <thead>
		                    	<tr role="row">
		                    		...
		                    		<th class="sorting" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="操作: activate to sort column ascending">操作</th>
		                    		</thead>
		                    ...
		                    <tbody><?php foreach ($res as $msg):?>
		                    	<tr>
		                    		...
		                    		<td><a href="<?php echo site_url('distribute/send_records/saler_logs?bn='.$msg->batch_no)?>">详情</a></td>
		                    	</tr><?php endforeach;?>
		                    </tbody>
		                  </table>
	                  </div>
                  ...
                  <div class="row">
                  <div class="col-sm-5">
                  <div class="dataTables_info" id="data-grid_info" role="status" aria-live="polite"><a href="<?php echo site_url('distribute/send_records/ext_batch_log/'.$batch_no.'_'.$from.'_'.$to);?>" class="btn btn-default">导出</a></div>
                  </div>
