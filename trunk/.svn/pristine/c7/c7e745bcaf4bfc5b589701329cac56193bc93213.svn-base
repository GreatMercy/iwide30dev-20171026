...
class Company_dispose_model extends CI_Model {
    ...
    public  function get_hotel_list($inter_id){
        ...
        $result = $this->db->query("SELECT * FROM `iwide_hotels` WHERE inter_id = '{$inter_id}'")->result_array();
    ...
    public  function getCompanyById($id){   //获取公司名称
        ...
        $result = $this->db->query("SELECT * FROM `iwide_company_list` WHERE company_id = '{$id}'")->result_array();
    ...
    public  function getCompanyPrice($id){   //获取当前公司的协议价情况
        ...
        $result = $this->db->query("SELECT * FROM `iwide_company_price` WHERE company_id = '{$id}'")->row();
    ...
    public  function getAllCompanyPriceCode($inter_id){   //获取当前公众号所有价格代码
        ...
        $result = $this->db->query("SELECT * FROM `iwide_hotel_price_info` WHERE inter_id = '{$inter_id}' AND type='protrol'")->result_array();
    ...
    public  function getCompanyHotel($inter_id,$company_id){   //获取加入协议客的酒店
        ...
        $result = $this->db->query("SELECT * FROM `iwide_company_price` WHERE inter_id = '{$inter_id}' AND company_id='{$company_id}' AND status=1")->result_array();
    ...
    public function confirmHotel($inter_id,$company_id,$hotel_id){   //合作的酒店
        ...
        $result = $this->db->query("SELECT * FROM `iwide_company_price` WHERE inter_id = '{$inter_id}' AND company_id='{$company_id}' AND hotel_id=$hotel_id")->row();
