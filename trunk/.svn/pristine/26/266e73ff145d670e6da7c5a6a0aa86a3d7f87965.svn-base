            ...
            <el-col :span="12">
              <el-form-item prop="regular_group" label="集团分成">
                <el-input v-model="item.select.regular_group === '3' ? '' : item.regular_group"
                          :disabled="item.select.regular_group === '3' || item.module ==='vip'" type="number">
                  <el-select
                    ...
                    <el-option label="百分比" value="1" :disabled="item.module ==='vip'"></el-option>
                    <el-option label="固定金额" value="2" :disabled="item.module ==='vip'"></el-option>
            ...
            <el-col :span="12">
              <el-form-item prop="regular_hotel" label="门店分成">
                <el-input v-model="item.select.regular_hotel === '3' ? '' : item.regular_hotel"
                          :disabled="item.select.regular_hotel === '3' || item.module ==='vip'" type="number">
                  <el-select
