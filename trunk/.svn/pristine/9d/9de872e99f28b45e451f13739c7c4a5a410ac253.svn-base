<template>
  <div class="jfk-picker" :class="{ 'is-3d': rotateEffect }">
    <div class="jfk-picker__toolbar" v-if="showToolbar"><slot></slot></div>
    <div class="jfk-picker__items">
      <picker-slot
      ...
      <div class="jfk-picker__center-highlight":style="{ height: itemHeight + 'px', marginTop: -itemHeight / 2 + 'px' }"></div>
    </div>
  </div>
</template>

<script>
  import pickerSlot from './picker'
  export default {
    name: 'JfkPicker',
