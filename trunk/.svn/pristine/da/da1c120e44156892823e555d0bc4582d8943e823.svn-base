...
<body>
<div class="ui_none" style="background-image:url(http://7n.cdn.iwide.cn/public/hotel/public/images/atten_01.png) "><div>在维护服务器, 请稍候再访问~</div></div>
