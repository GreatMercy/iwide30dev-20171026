...
<style>
.h24{font-size:12px !important}
.h28{font-size:14px !important}
.h36{font-size:18px !important}
.topoint tt{width:1.1em}
...
<div class="list_style">
    ...
    <div class="comment" style="display:block">
        <textarea style="font-size:14px" placeholder="亲～服务满意吗？留下个脚印吧～" id="msg" maxlength="100" rows="3" oninput="changerow(this)"></textarea>
        <div class="addimg">
            <div></div>
<!--        	<div>-->
...
<div class="foot_btn">
	<button type="submit" style="font-size:14px; position:static" class="btn_main bdradius footbtn disable" onclick="sub_comment()">提交评价</button>
</div>
<?php } else {?>
<div class="comment">
