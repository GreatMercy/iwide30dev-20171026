        ...
        <div class="content-wrapper">
            ...
            <div class="contents_list bg_fff">
              <div class="p_r_30 classification_n b_b_1 bg_fff" sytle="padding-left:20px;">
                <div class="add_active"><a href="javascript:;"> 全部社群客（<?php echo $amount['total'];?>）</a></div>
                <div class=""><a href="javascript:;"> 待审核社群客（<?php echo $amount['apply'];?>）</a></div>
              </div>
            </div>
                ...
                <table id="coupons_table" class="table-striped table-condensed dataTable no-footer new_tabels" style="width:100%;">
                  ...
                  <?php if(!empty($list)){ foreach($list as $clubList){ ?>
                    <tr class="form_con">
                      ...
                      <td> <?php echo $clubList['limited_amount'];?>/<?php echo $clubList['amount'];?></td>
                      <td>
                      ...
                      <td class="operations">
                        <a class="edits color_fff border_1_ff9900 bg_ff9900 template_btn m_l_4 m_r_4 m_b_5 m_t_3" href="<?php echo site_url('club_2/club_list/club_edit?ids=').$clubList['club_id'];?>">编辑</a>
                        <a class="looks color_ff9900 border_1_ff9900 template_btn m_l_4 m_r_4 m_b_5 m_t_3" href="<?php echo site_url('club_2/club_list/check?ids=').$clubList['club_id'];?>">查看</a>
                      </td>
                    </tr>
                  <?php }}?>
                  </tbody>
                  ...
                  <tbody class="containers dataTables_wrapper form-inline dt-bootstrap color_555">
                      <?php if(!empty($a_list)){ foreach($a_list as $a_clubList){ ?>
                          <tr class="form_con">
                              ...
                              <td> <?php echo $a_clubList['limited_amount'];?>/<?php echo $a_clubList['amount'];?></td>
                              <td>
                              ...
                              <td class="operations">
                                  <a class="edits color_fff border_1_ff9900 bg_ff9900 template_btn m_l_4 m_r_4 nowraps  m_b_5 m_t_3" href="<?php echo site_url('club_2/club_list/club_edit?ids=').$a_clubList['club_id'];?>">编辑资料</a>
                                  <a class="looks color_ff9900 border_1_ff9900 template_btn nowraps m_l_4 m_r_4  m_b_5 m_t_3"  onclick=batch_club(<?php echo $a_clubList['club_id'];?>)>审核通过</a>
                              </td>
                          </tr>
                      <?php }}?>
                  </tbody>
...
function batch_club(club_id){
        $.get('<?php echo site_url('club_2/Club_list/club_batch_post');?>',{
            club_id:club_id
        },function(data){
            if(data){
                alert(data.message);
