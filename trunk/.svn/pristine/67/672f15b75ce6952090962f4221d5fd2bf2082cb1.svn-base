...
$buttions.= '<button type="button" class="btn btn-default disabled single-btn" id="grid-btn-extra-2" target="qr"><i class="fa fa-qrcode"></i>&nbsp;生成朋友的券</button>';
...
?>
    ...
    $("#grid-btn-extra-2").click(function(){
    $.get("<?php echo EA_const_url::inst()->get_url("*/*/createWxFriendCard");?>", {ci_id:selected},
        function(errmsg){
          var errmsg = eval(errmsg);
            alert(errmsg.errmsg);
      },"text");
  });
});
