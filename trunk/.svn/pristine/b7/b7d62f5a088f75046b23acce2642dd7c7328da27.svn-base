...
<div class="page" style="padding-bottom:15%">
    <div class="cards_list">
        ...
        <a href="<?php echo base_url("index.php/bgyhotel/bindcard/qrcode?id=".$card->gc_id);?>" class="item">
            <div class="ui_img_auto_cut"><img src="<?php echo base_url("public/uploads/card/")."/".$card->logo_url;?>"></div>
...
<div style="position: fixed;  bottom: 0;  width: 100%;">
    <a class="ui_foot_btn"  href="<?php echo base_url("index.php/bgyhotel/bindcard/bind");?>">绑定另一张储值卡</a>
</div>
