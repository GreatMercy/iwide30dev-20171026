...
class Auth extends MY_Front_Iapi
{
    ...
    public function qrLogin()
    {
        ...
        //设置绑定状态和时间
        $this->valify_tokens_model->updateToken(array('id' => $token['id']), array('admin_id'=> $admin['admin_id'],'status' => 2,'confirm_time' => date('Y-m-d H:i:s')));
