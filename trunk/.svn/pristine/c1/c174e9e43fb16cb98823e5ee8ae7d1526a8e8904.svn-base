...
class Laudou extends MY_Controller {
    ...
    function lilang_room() {
        ...
        $pms_set = array (
                ...
                'pms_auth' => '{"url":"http:\/\/114.104.156.246:6565\/kws35\/","user":"WXKWS","pwd":"8888","channel_code":"WEC","market_code":"RET","source_code":"WEB","member_source":"WECHAT","multi_inn":1,"reserv_type":{"no_pay":1,"paid":1,"point":6},"FixedRate":1,"max_book_num":2,"no_remark_rate":1,"suborder_update":1,"pms_reduce_paypoint":1}' 
        );
