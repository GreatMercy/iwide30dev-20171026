...
class Service extends MY_Front_Soma
{
    ...
    {
        $result = $this->soma_db_conn->get('iwide_soma_activity_killsec', 1, 0)->result();
        $this->input->input_json();
    ...
    public function subscribemsg()
    {
        ...
        $result = \App\services\common\WxTempMsgService::getInstance()->getGuidweUrl($interID, $scene, $url, $reserved);
