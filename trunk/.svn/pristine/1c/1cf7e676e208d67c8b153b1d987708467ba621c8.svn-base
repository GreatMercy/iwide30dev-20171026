...
<div class="containers_fixed">
    <div class="fixed_box bg_fff b_radius_6" style="padding-top:0px;overflow:hidden;display:block">
        <form>
                ...
                <table id="coupons_table1" class="table-condensed no-footer" style="width:100%;">
                    ...
                    <tr class="form_con">
                        ...
                        <td class="available_price">
                            <div class="w_150 t_a_l m_auto" id='club_price_code'>
                    ...
                    <tr class="form_con">
                        <td>无需审核</td>
                        <td class="examine">
                            <div class="w_150 t_a_l m_auto" id='club_auth_price_code'>
          ...
          <table id="coupons_table" class="table-striped table-condensed dataTable no-footer new_tabels color_333" style="width:100%;">
            ...
            <?php if(!empty($club_staffs)){ foreach($club_staffs as $staff){ ?>
              <tr class="form_con">
                ...
                <td class="total"> <?php echo $staff['limited_amount'];?>/<?php echo $staff['amount'];?></td>
                <td>
                ...
                <td><?php if(isset($club_orders['count'][$staff['qrcode_id']]))echo $club_orders['count'][$staff['qrcode_id']];else echo 0;?></td>
...
$(function(){
  ...
  $('.looks_hotel').click(function(){
      ...
      $.post('<?php echo site_url('club_2/club/get_staff_info')?>',{
          saler:qrcode_id,
...
//          console.log(data.price_code);
          ...
          $.each(data.price_code,function(k,v){
              html_price_code += '<div class="input_checkboxs"><input type="checkbox" ';
...
//          $(".fixed_box_name").html(namr);
  ...
  $('.confirms').click(function(){
      ...
      $.getJSON('<?php echo site_url('club_2/club/edit_post')?>',{
              'data':json_str,
          <?php echo $csrf_token?>:'<?php echo $csrf_value?>'
          },
      function(data){
