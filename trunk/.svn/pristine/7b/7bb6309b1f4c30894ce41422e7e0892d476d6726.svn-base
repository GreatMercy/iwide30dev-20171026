<template>
  <div class="orderBtns jfk-pl-30 jfk-pr-30">
      <div class="jfk-flex btn-box">
        <div class="btn-item font-size--28">
          <i class="jfk-font icon-mall_icon_orderDetail_refund btn-item-icon font-size--36"></i>
        ...
        <div class="btn-item font-size--28">
          <i class="jfk-font icon-mall_icon_orderDetail_delete btn-item-icon font-size--36"></i>
        ...
        <div class="btn-item font-size--28">
          <i class="jfk-font icon-mall_icon_orderDetail_contact btn-item-icon font-size--36"></i>
