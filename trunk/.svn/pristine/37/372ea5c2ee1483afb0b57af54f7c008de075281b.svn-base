              ...
              <form action="<?php echo Soma_const_url::inst()->get_url('*/*/*' ); ?>" class="form" method='get' id="this_form" >
                ...
                <div class="j_head">
                 <!--  <div>
                    ...
                    <span>
                        <select id="settlement_select" class="w_130" name="settlement">
                          ...
                          <?php foreach($model->get_settle_label() as $k => $v): ?>
                            <option value="<?php echo $k; ?>" <?php if(isset($filter['settlement']) && $k == $filter['settlement']): ?> selected<?php endif; ?>><?php echo $v; ?></option>
                          <?php endforeach; ?>
                        </select>
                    </span>
                  </div>
                      ...
                      <span>
                          <select id="status_select" class="w_130" name="status">
                            ...
                            <?php foreach($model->get_status_label() as $k => $v): ?>
                              <option value="<?php echo $k; ?>" <?php if(isset($filter['status']) && $k == $filter['status']): ?> selected<?php endif; ?>><?php echo $v; ?></option>
                            <?php endforeach; ?>
                          </select>
                      </span>
                  </div>
                  <div>
                    ...
                    <span>
                      <select class="w_90" name="paytype">
                          ...
                          <option value="1">交易场景1</option>
                          <option value="2">交易场景2</option>
                          <option value="3">交易场景3</option>
                          <option value="4">交易场景4</option>
                      </select>
                    </span>
                  </div>
                  <div>
                  ...
                  <div>
                    <span>下单时间</span>
                    <span class="t_time"><input name="start_t" type="text" id="datepicker" class="datepicker moba" value="<?php echo isset($filter['start']) ? $filter['start'] : ''; ?>"></span>
                    <font>至</font>
                    <span class="t_time"><input name="end_t" type="text" id="datepicker2" class="datepicker moba" value="<?php echo isset($filter['end']) ? $filter['end'] : ''; ?>"></span>
                  </div>
                </div>
                ...
                <!-- <div class="head_cont contents_list bg_fff">
                  <div class="j_head clearfix">
                    ...
                    <div class="f_r f_r_con">
                      ...
                      <div class="color_A4C4ED" id="search_btn">筛选</div>
                    </div>
                  </div>
                </div> -->
              </form>
                ...
                <div class="border_1 m_t_10 bg_fff">
                  ...
                  <div class="table temp_con template p_t_10 p_b_10">
                    ...
                    <div>
                      ...
                      <span><?php echo $order['items'][0]['qty']; ?>份</span>
                    </div>
                    <div>
                    ...
                    <div>
                      <span><?php echo isset($order['contacts_info']['name']) ? $order['contacts_info']['name'] : '未知客户'; ?></span><br>
                      <span><?php echo isset($order['contacts_info']['mobile']) ? $order['contacts_info']['mobile'] : '未知号码'; ?></span>
                    </div>
                    <div>
                    ...
                    <div>
                      <span><?php echo $row[6]; ?></span><br>
                      <span class="color_ff9900"><?php echo $row[10]; ?></span>
                    </div>
                    <div>
...
$(function(){
    ...
    var url= "<?php echo Soma_const_url::inst()->get_url('*/*/export_list'); ?>" + '?1';
