...
<div class="containers_fixed">
  <div class="fixed_box bg_fff b_radius_6" style="overflow:hidden;display:block">
    ...
    <div class="content-wrapper" style="min-height: 775px;">
        ...
        <div class="contents">
            <div class="contents_list bg_fff box_list">
              ...
              <div class=" d_i_b">
                ...
                <div>
                  ...
                  <a class="looks color_ff9900 border_1_ff9900 template_btn m_15 looks " href="<?php echo base_url('club_2/club_list/ext_club_customer?ids=').$list['club_id'];?>">导出成员</a>
                </div>
              </div>
              <div class=" d_i_b">
            ...
            <div class="" style="padding:15px;text-align:center;">
                <a class="b_btn color_fff bg_ff9900 b_radius_6" href="<?php echo site_url("club_2/club_list/index");?>" style="display:inline-block;">关 闭</a>
            </div>
        </div>
    </div>
</div>
