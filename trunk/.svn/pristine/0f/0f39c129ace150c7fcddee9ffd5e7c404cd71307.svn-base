...
$db['iwide_soma_r'] = $db[$active_group];
$db['iwide_soma_r']['hostname'] = '30.iwide.cn';    //兼容性问题，请勿用 localhost
//$db['iwide_soma']['hostname'] = '10.0.0.250';    //兼容性问题，请勿用 localhost
$db['iwide_soma_r']['database'] = 'iwide30soma';
//$db['iwide_soma_r']['username'] = 'iwide30soma';
//$db['iwide_soma_r']['password'] = '9q5rKwUWVXmWLnzy';
