...
<?php if($centerinfo['value']=="login"){ ?>
	...
	<?php }else{ ?>
        <div class="btn_list h26">
            <a class="color_fff" href="<?php echo base_url("index.php/membervip/login");?>"><?php echo $inter_id=='a491796658'? '绑定':'登录'?></a> |
...
<?php } ?>
    ...
    <div class="display_flex number_list">
        ...
        <a href="<?php echo base_url("index.php/membervip/bonus?credit_type=1");?>" class="number_con">
            <p><?php if($centerinfo['value']=="login" && $centerinfo['member_mode'] ==1&&$inter_id!='a491796658' ){ echo '-';}else{ echo $centerinfo['credit']; } ?></p>
