...
<div class="over_x">
    <div class="content-wrapper" style="min-width: 1050px; min-height: 775px;">
        <div class="banner bg_fff p_0_20">编辑秒杀活动or新增秒杀活动</div>
        <div class="contents">
            <form action="<?php echo Soma_const_url::inst()->get_url('*/*/edit_post'); ?>" method="post">
                ...
                <input type="hidden" name="act_type" value="<?php if($model->m_get('act_type') != '') { echo $model->m_get('act_type'); } else { echo $model::ACT_TYPE_KILLSEC; } ?>" style="display:none;">
                ...
                <div class="contents_list bg_fff">
                    ...
                    <div class="con_right">
                        ...
                        <div class="hottel_name ">
                            <div class="">秒杀价</div>
                            <div class="input_txt"><input type="text" name="killsec_price" value="<?php echo $model->m_get('killsec_price'); ?>"></div>
                        </div><!-- 
                        <div class="hottel_name">
                            <div class="">价格</div>
                        ...
                        <div class="hottel_name ">
                            <div class="">秒杀名额</div>
                            <div class="input_txt"><input type="number" name="killsec_count" value="<?php echo $model->m_get('killsec_count'); ?>"></div>
                        </div>
                        <div class="hottel_name ">
                            <div class="">每人限购</div>
                            <div class="input_txt"><input type="number" name="killsec_permax" value="<?php echo $model->m_get('killsec_permax'); ?>">份</div>
                        </div>
                    ...
                    <div class="con_right">
                        <div class="hotel_star">
                            ...
                            <div class="input_txt input_radio">
                                <div>
                                    <input type="radio" id="star_16" name="is_stock" value="<?php echo Soma_base::STATUS_TRUE; ?>" <?php if($model->m_get('is_stock') == Soma_base::STATUS_TRUE): ?> checked="" <?php endif; ?>>
                                    <label for="star_16">显示</label>                                    
                                </div>
                                <div>
                                    <input class="btn_number" type="radio" id="star_17" name="is_stock" value="<?php echo Soma_base::STATUS_FALSE; ?>" <?php if($model->m_get('is_stock') == Soma_base::STATUS_FALSE): ?> checked="" <?php endif; ?>>
                                    <label for="star_17">不显示</label>
                                </div>
                            </div>
                        </div>
                        <div class="hotel_star">
                            ...
                            <div class="input_txt input_radio">
                                <div>
                                    <input type="radio" id="star_26" name="is_subscribe" value="<?php echo Soma_base::STATUS_TRUE; ?>" <?php if($model->m_get('is_subscribe') == Soma_base::STATUS_TRUE): ?> checked="" <?php endif; ?>>
                                    <label for="star_26">支持</label>                                    
                                </div>
                                <div>
                                    <input class="" type="radio" id="star_37" name="is_subscribe" value="<?php echo Soma_base::STATUS_FALSE; ?>" <?php if($model->m_get('is_subscribe') == Soma_base::STATUS_FALSE): ?> checked="" <?php endif; ?>>
                                    <label for="star_37">不支持</label>
                                </div>
                            </div>
                        </div>
                        <div class="jingwei">
                            <div class="">同步状态</div>
                            <div class="input_txt">
                                <select style="width:450px;" name="is_sync_center" disabled>
                                    <option value="<?php echo $model::SYNC_STATUS_TRUE; ?>" <?php if($model->m_get('is_sync_center') == $model::SYNC_STATUS_TRUE):?> selected <?php endif; ?>>是</option>
                                    <option value="<?php echo $model::SYNC_STATUS_FALSE; ?>" <?php if($model->m_get('is_sync_center') == $model::SYNC_STATUS_FALSE || $model->m_get('is_sync_center') == ''):?> selected <?php endif; ?>>否</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="hotel_star">
                            ...
                            <div class="input_txt input_radio">
                                <div>
                                    <input class="star_66" type="radio" id="star_66" name="schedule_type" value="<?php echo $model::SCHEDULE_TYPE_FIX; ?>" <?php if($model->m_get('schedule_type') == $model::SCHEDULE_TYPE_FIX): ?> checked="" <?php endif; ?>>
                                    <label for="star_66">按日期</label>                                    
                                </div>
                                <div>
                                    <input class="star_77" type="radio" id="star_77" name="schedule_type" value="<?php echo $model::SCHEDULE_TYPE_CYC; ?>" <?php if($model->m_get('schedule_type') == $model::SCHEDULE_TYPE_CYC): ?> checked="" <?php endif; ?>>
                                    <label for="star_77">按星期</label>
                                </div>
                            </div>
                        </div>
                        <?php
                        ...
                        ?>
                        <div class="hotel_star clearfix b_week" <?php if($model->m_get('schedule_type') != $model::SCHEDULE_TYPE_CYC): ?> style="display:none;" <?php endif; ?>>
                            <div class="float_left">选择星期</div>
                            <div class="input_txt input_checkbox p_l_4 w_600">
                                <div>
                                    <input type="checkbox" id="wf" name="schedule[]" value="1" <?php if(in_array(1, $schedule)): ?> checked <?php endif; ?>>
                                    <label for="wf">星期一</label>
                                </div>
                                <div>
                                    <input type="checkbox" id="con_room" name="schedule[]" value="2" <?php if(in_array(2, $schedule)): ?> checked <?php endif; ?>>
                                    <label for="con_room">星期二</label>
                                </div>
                                <div>
                                    <input type="checkbox" id="shuttle" name="schedule[]" value="3" <?php if(in_array(3, $schedule)): ?> checked <?php endif; ?>>
                                    <label for="shuttle">星期三</label>
                                </div>
                                <div>
                                    <input type="checkbox" id="luggage" name="schedule[]" value="4" <?php if(in_array(4, $schedule)): ?> checked <?php endif; ?>>
                                    <label for="luggage">星期四</label>
                                </div>
                                <div>
                                    <input type="checkbox" id="stop" name="schedule[]" value="5" <?php if(in_array(5, $schedule)): ?> checked <?php endif; ?>>
                                    <label for="stop">星期五</label>
                                </div>
                                <div>
                                    <input type="checkbox" id="swimming" name="schedule[]" value="6" <?php if(in_array(6, $schedule)): ?> checked <?php endif; ?>>
                                    <label for="swimming">星期六</label>
                                </div>
                                <div>
                                    <input type="checkbox" id="swimming12" name="schedule[]" value="7" <?php if(in_array(7, $schedule)): ?> checked <?php endif; ?>>
                                    <label for="swimming12">星期日</label>
                                </div>
                            </div>
                        </div>
                        <div class="hottel_name b_s_data">
                            <div class="">开始时间</div>
                            <div class="input_txt"><input class="form-control" type="text" name="killsec_time" id="el_killsec_time" value="<?php echo $model->m_get('killsec_time'); ?>"></div>
                        </div>
                        <script type="text/javascript">
                        ...
                        <div class="jingwei">
                            <div class="">持续时间</div>
                            <div class="input_txt">
                                <select style="width:450px;" name="end_time">
