...
use App\services\common\WxTempMsgService;
...
//        }
        ...
        if (isset($params['action'])  && $params['action'] === 'confirm') {
            ...
            $interID = $this->session->inter_id;

            $result = WxTempMsgService::getInstance()->sendMsg($interID, $params['openid'], $params['template_id'], $params['scene']);
