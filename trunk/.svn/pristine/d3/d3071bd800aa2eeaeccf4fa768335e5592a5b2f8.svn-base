<?php if(!empty($result)){ foreach($result as $r){?>
	<div onclick="go_hotel('<?php echo site_url('hotel/hotel/index?id=').$inter_id.'&h='.$r->hotel_id.$exe_param;?>')" tmp="<?php echo $r->hotel_id?>" class="webkitbox justify">
        ...
        <div class="info">
            ...
            <div class="h20 txtclip"><?php echo $r->address;?></div>
			<?php }?>
            ...
            <div class="h20">
            	<span class="btn_void xs" style="font-size:8px; color:#7f9fe9">预约退房</span>
            	<span class="btn_void xs" style="font-size:8px; color:#7f9fe9">预约退房</span>
            	<span class="btn_void xs" style="font-size:8px; color:#7f9fe9">预约退房</span>
            </div>
        ...
        <?php if(!empty($r->lowest)){?>
            ...
            <div class="qi">
                ...
                <span class="color_main h36" id="lowest_p_<?php echo $r->hotel_id;?>"><?php echo intval($r->lowest);?></span>
            </div>
			 <?php }else{?>>
            <div id="lowest_p_<?php echo $r->hotel_id;?>">满房</div>
             <?php }?>
         <?php }else{?>
