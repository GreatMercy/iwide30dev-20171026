                        ...
                        <div class="col-sm-12 col-sm-offset-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo $code_orderDetail['refund_status']; ?></td>
                                    <td><?php echo $code_orderDetail['consume_status']; ?></td>
                            ...
                            <table id="data-grid" class="table table-bordered table-striped table-condensed">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $order_orderDetail['refund_status']; ?></td>
                                        <td><?php echo $order_orderDetail['consume_status']; ?></td>
