      ...
      <!-- Content Wrapper. Contains page content -->
		<div class="content-wrapper">
			...
			<section class="content">
				...
				此日期内不使用：<textarea><?php if(!empty($pw['no_days'])) { echo $pw['no_days']; } ?></textarea>
				...
				<?php } ?>
				<br /></div><?php }}?><span>日期格式为年月日，连续日期以'-'相连，不连续日期以','相连，如  20160120,20160201-20160220</span></td>
                         ...
                         <tr>
                             ...
                             <td>
                                 ...
                                 <?php foreach($okpay_list as $ok=>$ov){?>
                                        <option value="<?php echo $ov['pay_type']?>" <?php if($okpay==$ov['pay_type']){?> selected='selectec'<?php }?>><?php echo $ov['pay_name']?></option>
                                 <?php }?>
                                 </select>
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
