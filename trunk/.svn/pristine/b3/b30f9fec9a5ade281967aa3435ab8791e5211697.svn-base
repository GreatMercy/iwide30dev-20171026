                                                ...
                                                <table class="k_contents" style="">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="price_list" >
                                                            <td>价格</td>
                                                            <?php foreach ($item['schedule'] as $schedule): ?>
                                                                <td><input min="0" max="500000"  step="0.01" type="number" value="<?php echo $schedule['price']; ?>"/></td>
                                                            <?php endforeach; ?>
                                                        </tr>
                                                    </tbody>
                                                </table>
...
$('.add_commodity').click(function(event){
    ...
    var places='<td><input type="text" /></td><td><input type="number" /></td><td><input type="number" /></td><td><input type="number" /></td><td><input type="number" /></td><td><input type="number"  min="0" max="500000" step="0.01" /></td><td><input type="number" /></td>';
    var Price='<td><input type="text" /></td><td><input type="number" min="0" max="500000"  step="0.01" /></td><td><input min="0" max="500000"  step="0.01"  type="number" /></td><td><input min="0" max="500000"  step="0.01"  type="number" /></td><td><input min="0" max="500000"  step="0.01"  type="number" /></td><td><input min="0" max="500000"  step="0.01"  type="number" /></td><td><input min="0" max="500000"  step="0.01"  type="number" /></td>';
