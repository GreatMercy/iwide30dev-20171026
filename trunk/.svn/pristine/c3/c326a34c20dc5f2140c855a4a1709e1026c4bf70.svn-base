...
#coupons_table_wrapper .row:nth-of-type(1){background:#fff;padding:10px 10px 5px 10px;}
#coupons_table{margin-top:0px !important;}
.form_con img{width:50px;height:50px;border-radius:50%;overflow:hidden;margin:auto;border:1px solid #d7e0f1;}
...
<div style="color:#92a0ae;">
    <div class="over_x">
        <div class="content-wrapper" style="min-width:1130px;">
            <div class="banner bg_fff p_0_20">商品分类</div>
            <div class="contents">
               ...
               <!--  <div class="head_cont contents_list bg_fff">
                  <div class="j_head clearfix">
                    <div  class="h_btn_list" style="">
                      <div class="actives" id='subbtn'>新增分类</div>
                      <div class="" id=''>批量导出</div>
                    </div>
                ...
                <table id="coupons_table" class="table-striped table-condensed dataTable no-footer" style="width:100%;">
                    ...
                    <tbody class="containers dataTables_wrapper form-inline dt-bootstrap">
                      <?php foreach($result['data'] as $row): ?>
                        <tr class="form_con">
                          <?php foreach($row as $key => $ceil): ?>
                            <?php if(is_numeric($key)): ?>
                              <td><?php echo $ceil; ?></td>
                            <?php endif; ?>
                          <?php endforeach; ?>
                          <td><a href="<?php echo Soma_const_url::inst()->get_url('*/*/edit', array('ids' => $row['DT_RowId'])); ?>" class="color_A4C4ED">编辑</a></td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
                </table>
...
function add() {
  var url = "<?php echo Soma_const_url::inst()->get_url('*/*/add'); ?>";
  window.location = url;
}

$(function(){
var buttons=$('<div  class="h_btn_list" style=""><div class="actives" id="subbtn" onclick="add()">新增分类</div><!--<div class="" id="">批量导出</div>--></div>')
...
$("#coupons_table_length").children().append('&nbsp;&nbsp;&nbsp;').append( buttons );
  var bool=true;
  var obj=null;
