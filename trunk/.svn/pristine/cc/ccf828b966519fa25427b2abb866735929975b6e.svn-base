...
<section class="bg_fff martop center">
    ...
    <div class="webkitbox bd_top pad3 h24">
        ...
        <?php if($order['status']==2 || ($inter_id=='a492669988' && $order['stauts']==1)){ if($order['is_invoice']==1){ ?>
            <a href="<?php echo site_url('hotel/invoice/check_out?oid=').$order['id'];?>" class="pad2 bd_left color_main"><?php if($inter_id=='a492669988'){ echo '开具发票';}else{echo '预约退房';}?></a>
