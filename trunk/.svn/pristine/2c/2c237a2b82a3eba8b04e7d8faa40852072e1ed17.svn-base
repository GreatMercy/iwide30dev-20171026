                  ...
                  <table id="data-grid" class="table table-bordered table-striped table-condensed">
                    <thead>
                    		<tr role="row">
                              	...
                              	<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="分销员所属酒店: activate to sort column ascending">分销员所属部门</th>
                              	...
                              	<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="旧商城绩效金额: activate to sort column ascending">旧商城绩效金额</th>
                              	<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="新商城绩效金额: activate to sort column ascending">新商城绩效金额</th>
                              	<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="套票商城绩效金额: activate to sort column ascending">套票商城绩效金额</th>
                              	<th class="sorting" tabindex="0" aria-controls="data-grid" rowspan="1" colspan="1" aria-label="拼团商城绩效金额: activate to sort column ascending">拼团商城绩效金额</th>
                    ...
                    <?php foreach ($res as $item):?>
                    	<tr>
                    		...
                    		<td><?=$item->GRADE_SHOPS?></td>
                    		<td><?=$item->GRADE_MALL?></td>
                    		<td><?=$item->GRADE_PACKAGE?></td>
                    		<td><?=$item->GRADE_GROUPON?></td>
