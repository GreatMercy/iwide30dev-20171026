...
(68, 'adminhtml', 6, 0, 'mall/invoice/index', '发票管理', '发票管理', '', 'fa-ticket', 6, 1),
    ...
    (5101, 'adminhtml', 5, 51, 'soma/sales_order/index', '订单管理', '订单管理', '', 'fa-shopping-cart', 5, 1),
    (5102, 'adminhtml', 5, 51, 'soma/consumer_order/index', '核销管理', '核销管理', '', 'fa-gg', 4, 1),
    ...
    (5105, 'adminhtml', 5, 51, 'soma/consumer_shipping/index', '订单邮寄', '订单邮寄', '', 'fa fa-ambulance', 3, 1),
    ...
    (5108, 'adminhtml', 5, 51, 'soma/sales_invoice/index', '发票邮寄', '发票邮寄', '', 'fa fa-money', 3, 1),
    ...
    (5503, 'adminhtml', 5, 55, 'soma/share_config/index', '分享配置', '分享配置', '', 'fa-share-alt', 6, 1),
    (5504, 'adminhtml', 5, 55, 'soma/theme_config_use/index', '皮肤选择', '皮肤选择', '', 'fa-puzzle-piece', 6, 1),
    (5505, 'adminhtml', 5, 55, 'soma/theme_config_use/receive', '赠送主题管理', '赠送主题管理', '', 'fa-gift', 6, 1),
    (5601, 'adminhtml', 5, 56, 'soma/statis_product/index', '商品数据', '商品数据', '', 'fa-cube', 1, 2),
    ...
    (5706, 'adminhtml', 5, 57, 'soma/activity_killsec/instance', '秒杀实例监测', '秒杀实例监测', '', 'fa-shopping-cart', 3, 1),
    (5707, 'adminhtml', 5, 57, 'soma/product_package/upattribute', '产品属性', '产品属性', '', 'fa-refresh', 3, 1),
    (5801, 'adminhtml', 5, 58, 'soma/sales_coupon/index', '优惠券管理', '优惠券管理', '', 'fa fa-money', 0, 1),
    (5802, 'adminhtml', 5, 58, 'soma/sales_base/index', '促销规则', '促销规则', '', 'fa fa-money', 0, 1),
    (5803, 'adminhtml', 5, 58, 'soma/sales_point/index', '积分赠送规则', '积分赠送规则', '', 'fa fa-money', 0, 1),
    (5901, 'adminhtml', 5, 59, 'soma/sales_voucher_exchange/index', '兑换记录', '兑换记录', '', 'fa fa-money', 0, 1),
    (5902, 'adminhtml', 5, 59, 'soma/sales_voucher_template/index', '批量生成模板', '批量生成模板', '', 'fa fa-money', 0, 1),
    (6001, 'adminhtml', 5, 60, 'soma/sales_reserve/index', '订购单', '订购单', '', 'fa fa-shopping-cart', 0, 1),
    (6002, 'adminhtml', 5, 60, 'soma/sales_reserve_product/index', '显示商品', '显示商品', '', 'fa fa-money', 0, 1),
...
(58, 'adminhtml', 5, 0, 'soma/sales_coupon/index', '促销管理', '促销管理', '', 'fa-money', 1, 1),
(59, 'adminhtml', 5, 0, 'soma/sales_voucher_exchange/index', '礼品卡券', '礼品卡券', '', 'fa-ticket', 1, 1),
(60, 'adminhtml', 5, 0, 'soma/sales_reserve/index', '大客户预定', '大客户预定', '', 'fa fa-diamond', 1, 1),
    
    (4101, 'adminhtml', 4, 41, 'soma/sales_order/index', '订单管理', '订单管理', '', 'fa-shopping-cart', 5, 1),
    (4102, 'adminhtml', 4, 41, 'soma/consumer_order/index', '核销管理', '核销管理', '', 'fa-gg', 4, 1),
    (4103, 'adminhtml', 4, 41, 'soma/refund_order/index', '退款管理', '退款管理', '', 'fa-cubes', 1, 1),
    (4104, 'adminhtml', 4, 41, 'soma/gift_order/index', '赠送管理', '赠送管理', '', 'fa-gift', 0, 1),
    (4105, 'adminhtml', 4, 41, 'soma/consumer_shipping/index', '订单邮寄', '订单邮寄', '', 'fa fa-ambulance', 3, 1),
    (4106, 'adminhtml', 4, 41, 'soma/reward_rule/index', '分销奖励规则', '分销奖励规则', '', 'fa fa-money', 0, 1),
    (4107, 'adminhtml', 4, 41, 'soma/reward_benefit/index', '分销奖励明细', '分销奖励明细', '', 'fa fa-money', 0, 1),
    (4108, 'adminhtml', 4, 41, 'soma/sales_invoice/index', '发票邮寄', '发票邮寄', '', 'fa fa-money', 3, 1),
    (4201, 'adminhtml', 4, 42, 'soma/cms_block/index', '推荐位管理', '推荐位管理', '', 'fa-thumbs-up', 0, 1),
    (4202, 'adminhtml', 4, 42, 'soma/message_wxtemp_template/index', '模板消息管理', '修改模板消息类型', '', 'fa-cube', 0, 2),
    (4203, 'adminhtml', 4, 42, 'soma/message_wxtemp_record/index', '模板消息记录', '模板消息记录', '', 'fa fa-file-o', 0, 2),
    (4301, 'adminhtml', 4, 43, 'soma/product_package/add', '月饼添加', '月饼添加', '', 'fa-plus', 1, 1),
    (4302, 'adminhtml', 4, 43, 'soma/product_package/index', '月饼管理', '月饼管理', '', 'fa-cube', 1, 1),
    (4303, 'adminhtml', 4, 43, 'soma/category_package/index', '月饼分类', '月饼分类', '', 'fa-cubes', 3, 1),
    (4401, 'adminhtml', 4, 44, 'soma/activity_package/add', '活动添加', '活动添加', '', 'fa-plus', 1, 1),
    (4402, 'adminhtml', 4, 44, 'soma/activity_package/index', '拼团活动', '拼图活动管理', '', 'fa-cube', 1, 1),
    (4403, 'adminhtml', 4, 44, 'soma/activity_killsec/index', '秒杀活动', '秒杀活动管理', '', 'fa-cube', 1, 1),
    (4501, 'adminhtml', 4, 45, 'soma/adv/add', '新增焦点图', '新增焦点图', '', 'fa-plus', 1, 1),
    (4502, 'adminhtml', 4, 45, 'soma/adv/index', '首页焦点图', '首页焦点图', '', 'fa-cube', 1, 1),
    (4503, 'adminhtml', 4, 45, 'soma/share_config/index', '分享配置', '分享配置', '', 'fa-share-alt', 6, 1),
    (4504, 'adminhtml', 4, 45, 'soma/theme_config_use/index', '皮肤选择', '皮肤选择', '', 'fa-puzzle-piece', 6, 1),
    (4505, 'adminhtml', 4, 45, 'soma/theme_config_use/receive', '赠送主题管理', '赠送主题管理', '', 'fa-gift', 6, 1),
    (4601, 'adminhtml', 4, 46, 'soma/statis_product/index', '商品数据', '商品数据', '', 'fa-cube', 1, 2),
    (4602, 'adminhtml', 4, 46, 'soma/sales_order/stat', '营销数据', '营销数据', '', 'fa-money', 1, 2),
    (4603, 'adminhtml', 4, 46, 'soma/statis_sales/index', '订单数据', '订单数据', '', 'fa-shopping-cart', 3, 1),
    (4701, 'adminhtml', 4, 47, 'soma/sales_reserve/index', '订购单', '订购单', '', 'fa fa-shopping-cart', 0, 1),
    (4702, 'adminhtml', 4, 47, 'soma/sales_reserve_product/index', '显示商品', '显示商品', '', 'fa fa-money', 0, 1),
    (4801, 'adminhtml', 4, 48, 'soma/sales_coupon/index', '优惠券管理', '优惠券管理', '', 'fa fa-money', 0, 1),
    (4802, 'adminhtml', 4, 48, 'soma/sales_rule/index', '促销规则', '促销规则', '', 'fa fa-money', 0, 1),
    (4803, 'adminhtml', 4, 48, 'soma/sales_point/index', '积分赠送规则', '积分赠送规则', '', 'fa fa-money', 0, 1),
    (4901, 'adminhtml', 4, 49, 'soma/sales_voucher_exchange/index', '兑换记录', '兑换记录', '', 'fa fa-money', 0, 1),
    (4902, 'adminhtml', 4, 49, 'soma/sales_voucher_template/index', '批量生成模板', '批量生成模板', '', 'fa fa-money', 0, 1),
    
(41, 'adminhtml', 4, 0, 'soma/sales_order/index', '交易管理', '交易管理', '', 'fa-cart-arrow-down', 1, 1),
(42, 'adminhtml', 4, 0, 'soma/adv/index', '内容管理', '内容管理', '', 'fa-file-o', 0, 1),
(43, 'adminhtml', 4, 0, 'soma/product_package/index', '月饼管理', '月饼管理', '', 'fa-ticket', 1, 1),
(44, 'adminhtml', 4, 0, 'soma/activity_package/index', '活动管理', '活动管理', '', 'fa-adn', 1, 1),
(45, 'adminhtml', 4, 0, 'soma/adv/index', '首页设置', '首页设置', '', 'fa-file-o', 1, 1),
(46, 'adminhtml', 4, 0, 'soma/sales_order/index', '数据分析', '数据分析', '', 'fa-bar-chart', 9, 1),
#(47, 'adminhtml', 4, 0, 'soma/reward_benefit/rebuild', '应急工具箱', '应急工具箱', '', 'fa-medkit', 0, 1),
(47, 'adminhtml', 4, 0, 'soma/sales_reserve/index', '大客户预定', '大客户预定', '', 'fa fa-diamond', 1, 1),
(48, 'adminhtml', 4, 0, 'soma/sales_coupon/index', '促销管理', '促销管理', '', 'fa-money', 1, 1),
(49, 'adminhtml', 4, 0, 'soma/sales_voucher_exchange/index', '礼品卡券', '礼品卡券', '', 'fa-ticket', 1, 1),
