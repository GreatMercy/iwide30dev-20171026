...
<div class="list_style">
    ...
    <div class="topoint" style="display:block">
        ...
        <ul class="h24" style="margin-bottom: 10px;"> 
            <li style="display:flex;justify-content: space-between;align-items:center;"><span>设施</span>
                <span class="iconfont color_main h36">
                    <tt>&#X23;</tt><tt>&#X23;</tt><tt>&#X23;</tt><tt>&#X23;</tt><tt>&#X23;</tt>
                    <input id="facilities_score" type="hidden" value='5'>
                </span>
            </li>
			<li style="display:flex;justify-content: space-between;align-items:center;"><span>卫生</span>
                <span class="iconfont color_main h36">
                    <tt>&#X23;</tt><tt>&#X23;</tt><tt>&#X23;</tt><tt>&#X23;</tt><tt>&#X23;</tt>
                    <input id="clean_score" type="hidden" value='5'>
                </span>
            </li>
			<li style="display:flex;justify-content: space-between;align-items:center;"><span>服务</span>
                <span class="iconfont color_main h36">
                    <tt>&#X23;</tt><tt>&#X23;</tt><tt>&#X23;</tt><tt>&#X23;</tt><tt>&#X23;</tt>
                    <input id="service_score" type="hidden" value='5'>
                </span>
            </li>
			<li style="display:flex;justify-content: space-between;align-items:center;"><span>网络</span>
                <span class="iconfont color_main h36">
                    <tt>&#X23;</tt><tt>&#X23;</tt><tt>&#X23;</tt><tt>&#X23;</tt><tt>&#X23;</tt>
    ...
    <div class="type" style="display:block;">
    	...
    	<div style="display:block;">
    		<ib class="beselect" data-type="0">商务出差</ib>
    		<ib data-type="1">商务出差</ib>
    		<ib data-type="2">商务出差</ib>
    		<ib data-type="3">商务出差</ib>
    		<ib data-type="4">商务出差</ib>
    	</div>
    </div>
...
$("ib").on("click",function(){
	if(this.className != ""){
		this.className = "";
		chuyou.remove(this.dataset.type);
	}else{
		this.className = "beselect";
		chuyou.push(this.dataset.type);
	}
});
