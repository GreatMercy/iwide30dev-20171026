...
//		}
    ...
    var GenerateCss = function () {
        ...
        tmp+="#mb_msg .loading{text-align: center;padding-bottom: 16px}";
        tmp+="#mb_msg .loading b{background-size:30px;width: 30px;height: 30px;display:inline-block; background-image: url('/public/soma/images/loading.gif');background-repeat:no-repeat;}";
		$('body').before(tmp);
