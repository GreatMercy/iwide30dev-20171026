  ...
  <div class="gradient_bg ">
    <section class="number_content padding_30 padding_0_15">
      ...
      <div class="between font_12 mar_t40">
        ...
        <p class="padding_0_20 padding_18 color_fff font_19">尊贵的会员，您获得了一张券</p>
      ...
      <div class="margin_top_42">
        <div v-for='(value,key) in dataList.card_info.card' class="coupon_rows border_radius layer_bg mar_b30">
          <a :href="['/cardinfo.html?member_card_id=' + value.member_card_id]">
    ...
    <section class="flex layer_bg fixed_btn font_17 color_fff">
      <div class="iconfont center main_bg1 padding_17" style="width:100%;">马上领取</div>
    </section>
  </div>
</template>
<script>
import { getCardReceive } from '@/service/http'
