<template>
  <section class="gradient_bg padding_0_15">
    <header>
      <div class="banner padding_top_15">
          <div class="relative radius_5 overflow"  v-if="data.centerinfo.is_login === 't' && data.centerinfo.member_mode == '1'">
              ...
              <div class="banner_txt absolute l_t_0 flex between font_15">
                ...
                <a class="block" :href="data.page_resource.links.reg">
      ...
      <div v-if="data.centerinfo.is_login === 't'" class="flex between padding_60 font_12 bd_bottom">
        ...
        <div class="flex_1">
          <a class="block flex between">
            <div>
              ...
              <p>{{data.centerinfo.membership_number}}</p>
            </div>
            <div v-if="data.centerinfo.is_login === 't' && data.centerinfo.member_mode === '2'">
              <a :href="data.page_resource.links.perfectinfo"><em class="iconfont font_15 bold">&#xe61c;</em></a>
            </div>
          </a>
      ...
      <div class="flex between padding_60 bd_bottom padding_0_14" v-if="data.centerinfo.is_login !== 't'">
        <a :href="data.page_resource.links.wxlogin" class="block margin_right_20 center flex_1 padding_15 relative border_1"><em class="iconfont font_19 margin_right_8">&#xe64f;</em>微信登陆</a>
        <a :href="data.page_resource.links.reg" class="block center flex_1 padding_16 color_fff bg_b2945e">会员登陆/注册</a>
      </div>
    </header>
    ...
    <section class="flex wrap margin_top_35 padding_bottom_77 font_12">
      <a v-for="(value,key) in menulist" class="block width_25" :href="value.link"> 
        <div class="flex column center padding_20">
          <!-- <p><em class="iconfont font_21 color_fff">{{value.icon}}</em></p> -->
