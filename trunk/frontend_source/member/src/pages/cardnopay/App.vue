<template>
  ...
  <section>
    ...
    <p class="jfk-font center color1 mar_t40 font_21">支付失败!</p>
    <p class="font_14 color3 center mar_t40 mar_b60">很抱歉，您没有支付成功，请重新下单支付!</p>
    <a :href="dataList.page_resource.links.restarturl" class="block width_85 center padding_15 auto jfk-font entry_btn reset">重新支付</a>
  </section>
