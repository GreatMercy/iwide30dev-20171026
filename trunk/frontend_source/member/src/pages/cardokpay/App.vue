<template>
  ...
  <section class="bd_bottom">
    ...
    <p class="jfk-font center color1 mar_t40 font_21">支付成功!</p>
    <div class="pad_tb40 center">
      <p class="inblock font_13 color3">恭喜您成功购买了会员卡，请在会员中心查看</p>
      <div class="inblock width_75 center relative border_1_808080 line_height_20 height_20 radius_3 color3 border_fff font_14"><a :href="dataList.page_resource.links.jump_url">会员中心</a></div>
    </div>
  </section>
...
<script>
import { getCardOkpay, updateOrderBuyer } from '@/service/http'
