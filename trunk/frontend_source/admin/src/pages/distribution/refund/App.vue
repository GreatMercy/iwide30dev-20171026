...
<script>
  // import { postRefund, getRefundOrder } from '@/service/distribution/http'
  ...
  export default {
    ...
    methods: {
      ...
      refundReconfirmed (trimRefundVal) {
        ...
        .then((res) => {
          api.postRefund(qs.stringify(param), {headers: {'Content-Type': 'application/x-www-form-urlencoded'}}).then((res) => {
