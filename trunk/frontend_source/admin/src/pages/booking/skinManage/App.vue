<template>
  <div class="jfk-pages jfk-pages__skinManage">
    <el-row>
    ...
    <el-row :gutter="20" type="flex" align="bottom">
      <el-col :span="8">
        <div class="demo">
          <h3>默认版</h3>
          <img src="../../../assets/image/white.jpg" />
        </div>
      </el-col>
      <el-col :span="6">
        <div class="qrcode">
    ...
    <el-row :gutter="20">
      <el-col :span="8">
        <div class="demo">
          <h3>高端黑</h3>
          <img src="../../../assets/image/black.jpg" />
          <el-button type="primary" class="btn">应 用</el-button>          
        </div>
      </el-col>
      <el-col :span="8">
        <div class="demo">
...
.demo img{
  ...
  margin-left: auto;
  margin-right: auto;
  box-shadow: 4px 5px 20px 5px rgba(0,0,0,0.1);
  border-radius: 4px;
}
.btn{
  width: 88px;
