...
import { OPEN_ID, NICENAME, HEADIMGURL, ACTNUM } from '../config/env'
...
const formatUrl = function (url, data, contentType) {
  ...
  urlParams.headingurl = data.headingurl || HEADIMGURL
  urlParams.nickname = data.nickname || NICENAME
  urlParams.act_num = data.act_num || ACTNUM
  delete data.openid
  delete data.headingurl
