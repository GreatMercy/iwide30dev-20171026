<template>
  <div class="killsec" v-show="visible">
      ...
      <div class="cont">
        <div class="time">
          ...
          <span class="clock jfk-d-ib">
            <i class="num date jfk-d-ib font-color-white font-size--48" v-show="killsecParams.dates > 0">{{killsecParams.dates}}</i>
            <i class="unit font-size--20 jfk-d-ib font-color-light-gray" v-show="killsecParams.dates > 0">天</i>
            <i class="num jfk-d-ib font-color-white font-size--48">{{killsecParams.hours}}</i>
            <i class="unit font-size--20 jfk-d-ib font-color-light-gray">时</i>
            <i class="num jfk-d-ib font-color-white font-size--48">{{killsecParams.minutes}}</i>
            <i class="unit font-size--20 jfk-d-ib font-color-light-gray">分</i>
            <i class="num jfk-d-ib font-color-white font-size--48">{{killsecParams.seconds}}</i>
    ...
    <div class="mask">
      <i class="jfk-font icon-font_zh_miao_fzdbs miao"></i>
      <i class="jfk-font icon-font_zh_sha_fzdbs sha"></i>
    </div>
  </div>
</template>
<script>
