<template>
  <div class="jfk-pages jfk-pages__roomDel">
    <div class="jfk-pages__theme"></div>
    <!--<p class="color-golden" v-show="isLoadProduct">loading</p>-->
    <!--<JfkSupport v-once></JfkSupport>-->
    <div class="swich_bar font-size--32 grayColor80">
      <span class="room">房型详情</span>
      <span class="room active">套餐详情</span>
    </div>
    <div class="detail_word font-size--28 jfk-pl-30 jfk-pr-30">
      <p class="title font-size--24 grayColor80">套餐明细</p>
      <p class="detail_word_item">
        1、详情详情详情详情详情详情详情详情详情详情详情详情详情详情详情详情详情；
      </p>
      <p class="detail_word_item">
        2、详情详情详情详情详情详情详情详情详情详情详情详情详情详情详情详情详情；
      </p>
      <p class="detail_word_item">
        3、详情详情详情详情详情详情详情详情详情详情详情详情详情详情详情详情详情；
      </p>
      <p class="desc grayColorbf font-size--24">
        <i class="booking_icon_font font-size--24 icon-msg_icon_prompt_default"></i>该套餐不支持取消及退款
      </p>
    </div>
    <div class="room_int">
