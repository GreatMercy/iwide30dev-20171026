...
<script>
  import { getBookroomDetail, getBookroomCoupon, getBookroomBonus, getPointpaySet, postSaveOrder } from '@/service/http'
  ...
  export default {
    created () {
      ...
      if (this.sendData.room_id) {
        this.xprice_type[this.sendData.room_id] = this.sendData.price_codes
        this.datas[this.sendData.room_id] = this.sendData.nums
      ...
      let setData = {
        ...
        nums: this.sendData.nums || '',
        price_codes: JSON.stringify(this.xprice_type) || '',
    ...
    methods: {
      ...
      getCoupon () {
        ...
        let couponData = {
          ...
          price_code: JSON.stringify(this.xprice_type) || '',
          // ================
          paytype: 'daofu',
