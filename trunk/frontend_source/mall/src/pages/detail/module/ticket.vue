<template>
  <div class="good-spec">
    <jfk-popup class="jfk-popup__specTicket" :onClose="onClose" v-model="specVisible" position="bottom"
               :showCloseButton="true" :closeOnClickModal="false" :lockScroll="true">
      <div class="popup-box">
        <div class="popup-ticket">
          ...
          <div class="ticket-calendar">
            <jfk-calendar ref="jfkCalendar" :minDate="min" :maxDate="max" :defaultValue="defaultValue"
                          :dateCellRender="dateCellRender" :disabledDate="disabledDate" @date-click="handleDateClick"
                          format="yyyy/MM/dd" class="font-size--28"></jfk-calendar>
          </div>
        </div>
      </div>
    </jfk-popup>
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      let maxHeight = this.maxHeight - toolHeight - theadHeight
