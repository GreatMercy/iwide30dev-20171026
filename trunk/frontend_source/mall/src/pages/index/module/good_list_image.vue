  ...
  <li>
    <a :href="detailUrl" class="item-cont">
      <div class="product-box">
        <div class="jfk-price-tag jfk-price-tag--large font-size--32"  :class="'jfk-price-tag--theme-' + product.tag" v-once v-if="product.tag > 0 && priceTagText">
          ...
          <div class="product-info__box jfk-clearfix">
            <div class="jfk-fl-l product-info--left">
              ...
              <div class="product-price font-size--24"  v-if="product.price_market" :class="'product-price--length-' + pricePackage.length">
                ...
                <span class="jfk-price__original product-price-market font-color-extra-light-gray" :class="{'is-integral': product.tag === 7}" v-once>{{priceMarket.html}}</span>
