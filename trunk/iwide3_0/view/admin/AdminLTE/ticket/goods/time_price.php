...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!--        <form action="<?php /*echo site_url('ticket/goods/add')*/?>" method="post" enctype="multipart/form-data" accept-charset="utf-8" class="form-horizontal">
-->
        <?php if(isset($ids)){?>
        ...
        <section class="content">
            ...
            <div class="whitetable">
                <div>
                    <span style="border-color:#FF5EA3">提前预约优惠</span>
                </div>
                <div class="bd_left list_layout">
                    <div>
                        <div>提前预约优惠</div>
                        <label class="check">
                            <input name="ticket_credits" onclick="change_ticket($(this).val())" type="radio" value="1" <?php if(isset($posts['ticket_credits'])&&$posts['ticket_credits']==1 || empty($posts['ticket_credits']))echo 'checked';?> />
                            <span class="diyradio"><tt></tt></span>
                            无效
                        </label>
                        <label class="check">
                            <input name="ticket_credits" onclick="change_ticket($(this).val())" type="radio" value="2" <?php if(isset($posts['ticket_credits'])&&$posts['ticket_credits']==2)echo 'checked';?> />
                            <span class="diyradio"><tt></tt></span>
                            有效
                        </label>
                    </div>
                    ...
                    <div class="ticket_credits" <?php if(isset($posts['ticket_credits']) && $posts['ticket_credits']==1 || empty($posts['ticket_credits'])){?>style="display: none;"<?php }?>>
                        <div>优惠方式</div>
                        <label class="check">
                            <input name="ticket_style" onclick="change_ticket_style($(this).val())" type="radio" value="1" <?php if(isset($posts['ticket_style'])&&$posts['ticket_style']==1 || !isset($ids))echo 'checked';?> />
                            <span class="diyradio"><tt></tt></span>
                            立减/份
                        </label>
                        <label class="check">
                            <input name="ticket_style" onclick="change_ticket_style($(this).val())" type="radio" value="2" <?php if(isset($posts['ticket_style'])&&$posts['ticket_style']==2)echo 'checked';?> />
                            <span class="diyradio"><tt></tt></span>
                            折扣
                        </label>
                    </div>
                    <div class="ticket_credits" <?php if(isset($posts['ticket_credits']) && $posts['ticket_credits']==1 || empty($posts['ticket_credits'])){?>style="display: none;"<?php }?>>
                        <div class="ticket_limit_name">
                            <?php
                            echo $posts['ticket_style'] == 2 ? '折扣额度': '立减额度';
                            ?>
                        </div>
            ...
            <div class="whitetable">
                ...
                <div class="bd_left list_layout">
                    ...
                    <div>
                        ...
                        <div class="input" id="sale_now_show" style="display: <?php echo $posts['sale_now'] == 2 ? 'block':'none';?>">
