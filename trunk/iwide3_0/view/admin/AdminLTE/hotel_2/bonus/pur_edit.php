            ...
            <div class="box-body">
                ...
                <div class="form-group col-xs-12 j_number">
                  ...
                  <div class="col-xs-8">
                      ...
                      <div class="radio"><label style="padding-left:0px;"><input type="checkbox" name='min_roomnight' style="margin-right:5px;" value="1"
                      <?php if (isset($list['extra_condition']['min_roomnight']))echo 'checked'?>>间夜满</label><input class="border_1" value='<?php if (isset($list['extra_condition']['min_roomnight']))echo $list['extra_condition']['min_roomnight'];?>' name='min_roomnight_v' type="number" style="width:80px;margin:0 5px;text-indent:3px;" min="1" />可用</div>
...
function sub(){
	...
	if(submit_tag==0){
		...
		$.post('<?php echo site_url('hotel/bonus/save_puserule')?>',$('#form1').serialize(),function(data){
			if(data.status==10){
				add_tag=1;
			}
