...
<div class="over_x">
	<div class="content-wrapper" style="min-width:1050px;">
		<div class="banner bg_fff p_0_20">编辑酒店／新增酒店</div>
		<div class="contents">
			<from>
						...
						<div class="hotel_star">
							...
							<div class="input_txt input_radio">
								<div>
									...
									<label for="star_5">5星/豪华</label>
								</div>
								<div>
									<input type="radio" id="star_4" name="1" value="4星/豪华"/>
									<label for="star_4">4星/豪华</label>
								</div>
								<div>
									<input type="radio" id="star_3" name="1" value="3星/豪华"/>
									<label for="star_3">3星/豪华</label>
								</div>
								<div>
									<input type="radio" id="economics" name="1" value="经济型"/>
									<label for="economics">经济型</label>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="contents_list bg_fff">
					<div class="con_left"><span class="block bg_ff503f"></span>酒店介绍</div>
					<div class="con_right">
						<div class="hottel_name clearfix">
							<div class="float_left">酒店简介</div>
							<div class="input_txt">
