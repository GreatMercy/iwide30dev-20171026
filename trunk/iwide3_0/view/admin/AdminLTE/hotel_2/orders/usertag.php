        ...
        <div class="content-wrapper" style="min-width:1130px;" >
            ...
            <div class="contents">
            		...
            		<div class="order_details clearfix">
            			...
            			<div class="order_d_r">
                            ...
                            <div style="padding-left:27px;">
                				<div class="states">
                					<span class="m_r_10 w_88"><i class="iconfont color_ff9900" style="margin-right:4px;">&#xe64d;</i>房间1:</span>
                                    <span class="state_con m_r_3">待确认</span>
	                				<div  class="h_btn_list even_btn" style="display:inline-block;">
	    								<div class="actives bg_ff9900 color_fff border_none template_btn_1">待确认</div><div class="actives bg_ff9900 color_fff border_none template_btn" style="display: none;">入住</div>
	    								<div class="bg_7e8e9f color_fff border_none template_btn2">取消订单</div>
	    							</div>
                                </div>
                				<div class="states">
                					<span class="m_r_10 w_88"><i class="iconfont" style="margin-right:4px;">&nbsp;</i>房间2:</span>
                                    <span class="state_con m_r_3">待确认</span>
	                				<div  class="h_btn_list even_btn" style="display:inline-block;">
                				...
                				<div class="states">
                					<span class="m_r_10 w_88"><i class="iconfont " style="margin-right:4px;">&nbsp;</i>房间3:</span>
                                    <span class="state_con m_r_3">待确认</span>
	                				<div  class="h_btn_list even_btn" style="display:inline-block;">
	    								<div class="actives bg_ff9900 color_fff border_none template_btn_1">待确认</div><div class="actives bg_ff9900 color_fff border_none template_btn" style="display: none;">入住</div>
	    								<div class="bg_7e8e9f color_fff border_none template_btn2">取消订单</div>
                				...
                				<div class="states">
                					<span class="m_r_10 w_88"><i class="iconfont" style="margin-right:4px;">&nbsp;</i>房间4:</span>
                                    <span class="state_con m_r_3">待确认</span>
	                				<div  class="h_btn_list even_btn" style="display:inline-block;">
	    								<div class="actives bg_ff9900 color_fff border_none template_btn_1">待确认</div><div class="actives bg_ff9900 color_fff border_none template_btn" style="display: none;">入住</div>
	    								<div class="bg_7e8e9f color_fff border_none template_btn2">取消订单</div>
                				...
                				<div class="states aas">
                					<span class="m_r_10 w_88"><i class="iconfont" style="margin-right:4px;">&nbsp;</i>房间5:</span>
                                    <span class="state_con m_r_3">待确认</span>
	                				<div  class="h_btn_list even_btn" style="display:inline-block;">
	    								<div class="actives bg_ff9900 color_fff border_none template_btn_1">待确认</div><div class="actives bg_ff9900 color_fff border_none template_btn" style="display: none;">入住</div>
	    								<div class="bg_7e8e9f color_fff border_none template_btn2">取消订单</div>
            	...
            	<div class="bg_fff border_1">
            		<div class="bg_f8f9fb b_b_1" style="text-align:center;padding:8px 0 5px 0;">用户分析</div>
...
$(function(){
    ...
    $('.template_btn').click(function(){
        ...
        if(bool){
            ...
            $('.confirms').click(function(){
                faout();
                _this.parent().parent().find('.state_con').html('已入住');
                _this.parent().parent().find('.template_btn2').remove();
                _this.parent().parent().find('.even_btn').append(btn_s);
                if(switch2){
                	switch2=false;
    ...
    $('.template_btn2').click(function(){
        if(bool){
            ...
            $('.confirms').click(function(){
                faout();
                _this.parent().parent().find('.state_con').html('已取消');
                _this.parent().parent().find('.template_btn2,.template_btn,.template_btn_1').remove();
               // $('.d_t_con:nth-of-type(2) >p:nth-of-type(2)').html(toTimes());
    ...
    $('.even_btn').delegate('.template_btn3','click',function(){
        if(bool){
            ...
            $('.confirms').click(function(){
                faout();
                _this.parent().parent().find('.state_con').html('已离店');
                _this.remove();
                if(switch3){
                	switch3=false;
