...
<!-- form start -->
        ...
        <div class="tab-content">
			...
			<?php echo form_open( site_url('hotel/orders/hotel_order_exp'), array('id'=>'code_form','class'=>'form-inline','enctype'=>'multipart/form-data' ), array('orderid'=>$list['orderid'],'hotel_id'=>$list['hotel_id']) ); ?>
                <div class="box-body">
