...
<div style="color:#92a0ae;">
    <div class="over_x">
        <div class="content-wrapper" style="min-width:1130px;">
            <div class="banner bg_fff p_0_20">发票邮寄</div>
            <div class="contents">
              <div class="p_r_30 classification_n b_b_1 bg_fff w_auto">
              ...
              <?php foreach($result['data'] as $row): ?>
                <?php $order = $row['order_info']; ?>
                <div class="border_1 m_t_10 bg_fff">
                  <div class="bg_f8f9fb fomr_term p_0_30_0_10 b_b_1">
                    <a href="<?php echo Soma_const_url::inst()->get_url('*/*/edit', array('ids' => $row['DT_RowId'])); ?>" class="f_r color_F99E12">邮寄详情</a>
                  ...
                  <div class="table temp_con template p_t_10 p_b_10">
                    ...
                    <div>
                      <span><?php echo $row[4]; ?></span><br>
                      <span></span>
                    </div>
                    <div>
                      <span><?php echo $row[9]; ?></span><br>
                      <span><?php echo $row[10]; ?></span>
                    </div>
                    <div>
                      <span><?php echo $row[8]; ?></span><br>
                      <span></span>
                    </div>
                    <div>
                      <span><?php echo $row[11]; ?></span><br>
                      <!-- <span class="color_ff9900 delivery">待发货</span> -->
                    </div>
                    <div class="f_times">
                      <?php $mail_time_arr = explode(' ', $row[7])?>
...
$('#export_btn').click(function(){
    ...
    <?php 
      $exp_filter = $this->input->get('filter', true);
      if(!is_array($exp_filter)) { $exp_filter = array(); }
    ?>
