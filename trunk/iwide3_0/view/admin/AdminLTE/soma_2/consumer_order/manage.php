...
<div class="over_x">
    <div class="content-wrapper" style="min-width:1050px;">
        <div class="banner bg_fff p_0_20">商品核销</div>
        <div class="contents">
            <from>
                <div class="contents_list bg_fff" id="code_consumer">
                    <div class="con_left"><span class="block bg_3f51b5"></span>实时核销</div>
                    <div class="con_right">
                    <a class="record" href="<?php echo Soma_const_url::inst()->get_url('*/*/consumer_order_record'); ?>">核销记录</a>
                        <div class="hottel_name coupon_code">
                            <div class="">券码</div>
                            <div class="input_txt"><input type="text" id="consumer_code"/><span onclick="ajax_consumer_code_info()" class="color_A4C4ED" style="cursor: pointer; margin-left:20px;">查询</span></div>
                        </div>
                        <div class="hottel_name coupon_code">
                            <div class="">核销备注</div>
                            <div class="input_txt"><input type="text" id="code_consumer_remark" /></div>
                        </div>
                        <div class="bg_fff" style="padding:15px;">
                            <button class="fom_btn" onclick="ajax_code_consumer(<?php echo Consumer_order::TYPE_BOOKING_CONSUMER; ?>)">预约并核销</button>
                            <button class="fom_btn" onclick="ajax_code_consumer(<?php echo Consumer_order::TYPE_BOOKING; ?>)">预约</button>
                        </div>
                        <!--
                        <div class="box-body">
                            <table id="coupons_table" class="table-striped table-condensed dataTable no-footer" style="width:100%;">
                                <thead class="bg_f8f9fb form_thead">
                                    <tr class="bg_f8f9fb form_title title1_length">
                                        <th>酒店</th>
                                        <th>商品名</th>
                                        <th>购买方式</th>
                                        <th>实付金额</th>
                ...
                <div class="contents_list bg_fff" id="order_consumer">
                    <div class="con_left"><span class="block bg_3f51b5"></span>实时核销</div>
                    <div class="con_right">
                    <a class="record" href="<?php echo Soma_const_url::inst()->get_url('*/*/consumer_order_record'); ?>">核销记录</a>
                        <div class="hottel_name coupon_code">
                            <div class="">订单编号</div>
                            <div class="input_txt"><input type="text" id="consumer_order" placeholder="请输入订单编号进行核销" /><span onclick="ajax_consumer_order_info()" class="color_A4C4ED" style="cursor: pointer; margin-left:20px;">查询</span></div>
                        </div>
                        <div class="hottel_name coupon_code">
                            <div class="">核销分数</div>
                            <div class="input_txt"><input type="text" id="consumer_order_num"/></div>
                        </div>
                        <div class="bg_fff" style="padding:15px;">
                            <button class="fom_btn" onclick="ajax_consumer_order()">核销</button>
                        </div>
                        <!--
                        <div class="box-body">
                            <table id="coupons_table" class="table-striped table-condensed dataTable no-footer" style="width:100%;">
                                <thead class="bg_f8f9fb form_thead">
                                    <tr class="bg_f8f9fb form_title title2_length">
                                        <th>酒店</th>
                                        <th>商品名</th>
                                        <th>购买方式</th>
                                        <th>实付金额</th>
                ...
                <div class="contents_list bg_fff">
                    <div class="con_left"><span class="block bg_ff503f"></span>扫码核销</div>
                    <div class="con_right clearfix">
                        <a class="record" href="<?php echo Soma_const_url::inst()->get_url('privilege/adminuser/profile'); ?>">授权管理</a>
                        <div class="erwm"><img src="<?php echo Soma_const_url::inst()->get_url('*/*/show_consume_code', array('id'=> $inter_id) ); ?>" /></div>
                        <div>
                            <p>注意事项:</p>
                            <p>1.使用此功能必须先对扫码微信号进行授权</p>
                            <p>2.授权只需一次操作,无须重复授权,本管理员有责任对授权账号进行审核通过和清退操作</p>
                            <p>3.授权后微信号所做的操作将等同于本管理员的操作,其操作造成的损失由本管理员承担</p>
                            <p>4.一旦进行扫码操作,即等同于同意以上内容</p>
                            <p>5.一切授权工作完成，扫一扫左边二维码即可开始核销等操作</p>
                        </div>
                    </div>
                </div>
                <div class="contents_list bg_fff" id="modify_expire">
                    <div class="con_left"><span class="block bg_4caf50"></span>核销延期</div>
                    <div class="con_right">
                        <div class="jingwei">
                            <div class="">选择商品</div>
                            <div class="input_txt" >
                                <select id="expire_product" style="width:450px;">
                                ...
                                <span onclick="ajax_consumer_product_info()" class="color_A4C4ED" style="cursor: pointer; margin-left:20px;">查询</span>
                            </div>
                        </div>
                        <!--
                        <div class="box-body">
                            <table id="coupons_table" class="table-striped table-condensed dataTable no-footer" style="width:100%;">
                                <thead class="bg_f8f9fb form_thead">
                                    <tr class="bg_f8f9fb form_title title3_length">
                                        <th>序号</th>
                                        <th>商品ID</th>
                                        <th>商品名称</th>
                                        <th>过期日期</th>
                        ...
                        -->
                        <div class="expire_btn bg_fff" style="padding:15px;">
                            <button class="fom_btn" onclick="ajax_consumer_product()">确定延期</button>
                        </div>
                    </div>
                </div>
            </from>
    ...
    function ajax_consumer_product_info() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var html = generate_table_html(data['header'], data['data']);
                var form = '<form id="expire_product_form" style="margin-bottom:12px;" >' + html + '</form>'
                $('#modify_expire .con_right .expire_btn').prepend(form);
                // expireTime
