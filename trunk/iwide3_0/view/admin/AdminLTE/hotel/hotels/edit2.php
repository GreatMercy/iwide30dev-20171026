	...
	echo form_open( EA_const_url::inst()->get_url('*/*/edit_post'), array('class'=>'form-horizontal'), array($pk=>$model->m_get($pk) ) ); ?>
		<div class="box-body">
			...
			<div class="form-group ">
            		<label for="el_arounds" class="col-sm-2 control-label">酒店周边</label>
                    <div class="col-sm-8">
                        <textarea class="form-control wysihtml5" name="arounds" id="arounds" placeholder="酒店周边" rows="10" cols="80"><?php echo $detail_field; ?></textarea>
                    </div>
            </div>
