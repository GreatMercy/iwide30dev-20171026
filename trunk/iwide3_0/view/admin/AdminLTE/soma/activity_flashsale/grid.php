...
<script src="<?php echo base_url(FD_PUBLIC) ?>/soma/flashsale/js/index.js"></script>
</head>
...
<!--                        <a href="--><?php //echo $pageUrl,$page;?><!--" class="btn f32">确 定</a>-->
                ...
                <div class="kill-layer" style="display: none" id="homebuying">
                    <div class="layer-content">
                        <div class="close"></div>
                        <p class="title f32">提 示</p>

                        <div class="homebuying">
                            <div class="homebuying-title" id="homebuyingTitle"></div>
                            <div class="homebuying-table">
                                <table id="homebuyingTable">
                                </table>
                            </div>
                        </div>
