...
.h_btn_list> a{display:inline-block;width:100px;border:1px solid #d7e0f1;text-align:center;padding:6px 0px;border-radius:5px;margin-right:8px;}
</style>
...
<!--            <div class="actives">新增</div>-->
                <a class="color_fff actives" href="<?php echo Soma_const_url::inst()->get_url('*/*/edit'); ?>" >新增</a >
          </div>
        </div>
...
$(function(){
  $('.copy_btn').click(function(){
    var j_url=$(this).parents('.form_con').find('.website');
      j_url.select();
