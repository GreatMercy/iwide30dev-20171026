              ...
              <!-- 
                ...
                <div class="box-body">
                  ...
                  <div class="row">
	                  ...
	                  <?php echo form_close();?>
	                  <ol id="parent">
	                  	<?php $i=1; foreach ($menus as $note):$i++;?>
	                  	<li mid="<?php echo isset($note['id'])?$note['id']:'';?>" sort="<?php echo isset($note['sort'])?$note['sort']:'';?>">
	                  		<p><span mid="<?php echo isset($note['id'])?$note['id']:'';?>">
	                  	...
	                  	<?php foreach ($note['sub_items'] as $sub_note):?>
	                  	<li mid="<?php echo isset($sub_note['id'])?$sub_note['id']:'';?>" sort="<?php echo isset($sub_note['sort'])?$sub_note['sort']:'';?>">
	                  	<p><span mid="<?php echo isset($note['id'])?$note['id']:'';?>" sid="<?php echo isset($sub_note['id'])?$sub_note['id']:'';?>">
	                 ...
	                 <form action="" id="edit_form">
						...
						<div class="form-group" id="sort_box">
						    <label for="parent_name">排序</label>
...
$(function() {
    ...
    $('.fa-remove').click(function(){
        if(confirm('删除后将不可恢复，确定要删除吗？')){
	        var _id = $(this).parent().parent().parent().attr('mid');
	...
	$('#btn_save').click(function(){
		...
		$.each(lis,function(k,v){
			var obj = $(v);
			posStr += ',' + obj.attr('mid') + ':' + obj.attr('sort');
		});
