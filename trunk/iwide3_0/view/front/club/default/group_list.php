...
<div class="tabmenus webkitbox center bg_fff">
	<div class="bg_E4E4E4 bg_main" type='0'>已审核</div>
	<div class="bg_E4E4E4" type='1' show='0'>审核中</div>
	<div class="bg_E4E4E4" type='1' show='1'>已失效</div>
</div>
    ...
    <div item class="bg_fff">
    	<div class="webkitbox justify bd_bottom">
            ...
            <div class="h18">
                ...
                <p status value="<?php echo $info['status'];?>" valid="<?php echo $info['valid'];?>"><?php
	...
	if($('[item]').length>0){
		if($(this).attr('type')==0){
            $('[item]').each(function(index, element) {
                if($('[status]',this).attr('value')==1 && $('[status]',this).attr('valid')!=1 && $('[status]',this).attr('valid')!=5 && $('[status]',this).attr('valid')!=6){
//                    console.log($('[status]',this).val());
//                    console.log($('[status]',this).attr('valid'));
                    $(this).show();
                }else{
                    $(this).hide();
                }
...
//			$('[item]').show();
            ...
            if($(this).attr('show')==0){
                ...
                $('[item]').each(function(index, element) {
                    var list_value = $('[status]',this).attr('value');
                    var list_valid = $('[status]',this).attr('valid');
                    if(list_value==2 || list_value==3 || (list_value==1 && (list_valid==1 || list_valid==5 || list_valid==6))){
                        $(this).show();
                        length++;
                    }else{
                        $(this).hide();
