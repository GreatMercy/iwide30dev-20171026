    ...
    <?php if(!empty($card_info['is_package']) && $card_info['is_package']=='f'):?>
        ...
        <div class="pad10 center">
            <?php if(!empty($card_info['frequency']) && $card_info['frequency']>$gain_count):?>
                ...
                <a href="<?php echo site_url("membervip/card");?>" style="display:none;"><div class="gain_btn look_card">立即查看</div></a>
            <?php else:?>
                <a href="<?php echo site_url("membervip/card");?>"><div class="gain_btn look_card">立即查看</div></a>
            <?php endif;?>
        </div>
