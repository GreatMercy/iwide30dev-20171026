...
<!-- <div style="padding-top:15%;"> 
    ...
    <flex class="tc" <?php if(isset($hide) && $hide) echo 'style="display:none";' ; ?>>
        <div class="tc_body">
            <div>
                <div>会员卡泛分销绩效</div>
                <div>亲爱的会员朋友：</div>
...
<script>
    ...
    wx.config({
        ...
        jsApiList: [<?php echo (isset($js_api_list) && !empty($js_api_list))?$js_api_list:'' ; ?>,'getLocation','openLocation']
    });
    wx.ready(function(){
