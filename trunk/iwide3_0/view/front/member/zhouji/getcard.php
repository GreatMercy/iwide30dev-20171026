...
<?php if($card_info){ ?>
    <?php if(isset($card_info['get_type']) && $card_info['get_type']=='f' && (!isset($card_info['err']) || $card_info['err']==0)):?>
        <div class="content">
            <div class="con_name">
    ...
    <?php elseif (isset($card_info['get_type']) && $card_info['get_type']=='t' && (!isset($card_info['err']) || $card_info['err']==0)):?>
        <div class="content">
            <div class="con_name">
                <div class="na_img img_auto_cut"><img src="<?php echo $public['logo'];?>"></div>
                <div class="na_text">
            ...
            <div class="coupon">
                ...
                <div class="cou_con">
                    <?php if(isset($card_info['membership']) && isset($card_info['level_conf']) && isset($card_info['level_conf'][$card_info['membership']])):?>
                        <p class="package_text">等级: <?php echo $card_info['level_conf'][$card_info['membership']];?></p>
                    <?php endif;?>
                    ...
                    <?php if(isset($card_info['credit']) && isset($card_info['credit'])):?>
                        <p class="package_text">积分: <?php echo $this->_ci_cached_vars['filed_name']['credit_name'];?></p>
                    <?php endif;?>
                <?php if(isset($card_info['cardlist']) && is_array($card_info['cardlist'])):?>
<!--                    <p class="con_text">--><?php //echo $card_info['cardlist']['count_num'];?><!--张券</p>-->
                    <?php foreach ($card_info['cardlist'] as $kc => $vo):?>
    ...
    <?php endif;?>
<div class="flooter">
        <?php if(isset($card_info['frequency']) && $card_info['frequency']>$gain_count && isset($card_info['get_type']) && $card_info['get_type']=='f' && (!isset($card_info['err']) || $card_info['err']==0)){ ?>
        ...
        <?php }elseif(isset($card_info['get_type']) && $card_info['get_type']=='f' && (!isset($card_info['err']) || $card_info['err']==0)){ ?>
        ...
        <?php if(isset($card_info['frequency']) && isset($card_info['get_type']) && $card_info['get_type']=='t' && $card_info['frequency']>$gain_count && (!isset($card_info['err']) || $card_info['err']==0)){ ?>
