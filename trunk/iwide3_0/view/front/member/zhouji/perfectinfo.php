...
<form id="SaveMemberInfo" action="<?php echo base_url("index.php/membervip/perfectinfo/save");?>" method="post" >
    ...
    <div class="list_style martop bd">
        ...
        <div class="webkitbox justify birthday arrow" style="position:relative">
            ...
            <input class="diydate" type="date" value="<?php echo date('Y-m-d',$centerinfo['birth']); ?>" style="opacity:0; position:absolute; width:100%; height:100%;left:0; top:0">
            <input name="birthday" readonly type="text" value="<?php echo date('Y-m-d',$centerinfo['birth']); ?>" pattern="<?php echo $modify_config['birthday']['regular']; ?>" >
        </div>
        <?php }?>
