...
<!--                     </div> -->
                    <div class="is-member_type" data-show="0">
                        ...
                        <div class="weui_cell idno">
                            ...
                            <div class="weui_cell_bd weui_cell_primary">
                                <label><input type="radio" id="member" disabled name="member_type" value="97" checked />&nbsp;员工</label>
                        ...
                        <div class="weui_cell idno">
                            <div class="weui_cell_hd"><label for='' class="weui_label">员工号或业主证号</label></div>
                            <div class="weui_cell_bd weui_cell_primary">
                                <input class="weui_input" disabled type="text" pattern="^[A-Za-z0-9]{2,}$"  placeholder="请输入员工号或业主证号" name="employee_id"/>
                            </div>
                            <div class="weui_cell_ft">
                                <i class="weui_icon_warn"></i>
                            </div>
