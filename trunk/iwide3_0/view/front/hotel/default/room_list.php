        ...
        <div class="item_foot" style="display:none;">
            ...
            <?php if(!empty($r['state_info'])){ foreach($r['state_info'] as $si){?>
            	<div class="pay_way">
                    ...
                    <div class="item_right">
                        <div class="ui_price"><b><?php echo $si['avg_price'];?></b> <div class="h20 color_999">均价</div></div>
...
// 				}
				...
				if(n.state_info!=''){
					$.each(n.state_info,function(sk,sn){
						...
						temp+='<div class="item_right"><div class="ui_price"><b>'+sn.avg_price+'</b><div class="h20 color_999">均价</div></div>';
