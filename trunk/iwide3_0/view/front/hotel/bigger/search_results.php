...
<div class="gradient_bg search_results_wrapper" id="j_window">
    ...
    <div class="blankpage" style="display:none;margin-bottom: 100px;">
        <p class="iconfont">&#xe055;</p>
...
<section class="city_wrapper bg_090909" style="display:none;" id="serach_whole">
    <div class="h20 layer_bg whole_eject_content pad_t80 pad_b40 pad_lr30 border_radius scroll" style="height: 96%;margin: 4%;">
        ...
        <div id="city_search_result" style="display:none;" class="mar_t60">

        </div>
        <div id="city_no_search_result"  style="display:none;" class="">
