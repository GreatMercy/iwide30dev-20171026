...
<div class="whiteblock ">
	<div><em class="iconfont color_main hide">&#xe620;</em>此商品由<?php echo $public['name']; ?>提供</div>
</div>
...
<div class="bg_fff block martop h24">
	<p class="bd_bottom">
    	<em class="iconfont color_999 hide">&#xe620;</em>
...
<div class="bg_fff bd martop block h24 color_555">
	<p class="bd_bottom"><em class="iconfont color_999 hide">&#xe620;</em>商品内容</p>
...
<?php if($package['img_detail'] != null && $package['img_detail'] != ''): ?>
    <div class="bg_fff bd martop block h24 color_555" id="showdetail">
    	<p class="bd_bottom"><em class="iconfont color_999 hide">&#xe620;</em>图文详情</p>
...
<?php if($package['hotel_address'] != null && $package['hotel_address'] != ''): ?>
    <div class="bg_fff bd martop block" id="openLocation">
        <p class="txtclip" style="width:95%;"><em class="iconfont color_999 hide">&#xe620;</em>地址：<?php echo $package['hotel_address'];?></p>
    </div>
<?php endif; ?>
...
<div class="foot_fixed">
    <div class="bg_fff webkitbox bd_top">
        <a href="<?php echo Soma_const_url::inst()->get_pacakge_home_page(array('id'=>$inter_id)); ?>" class="img_link color_999"><img src="<?php echo get_cdn_url('public/soma/images/img'); ?>/ico9_en.png"/><div style="font-size:8px; white-space:nowrap">main page</div></a>
        <a href="<?php echo Soma_const_url::inst()->get_soma_ucenter(array('id'=>$inter_id)); ?>" class="img_link color_999"><img src="<?php echo get_cdn_url('public/soma/images/img'); ?>/ico10_en.png"/><div style="font-size:8px; white-space:nowrap">my orders</div></a>
	
        <!-- <a class="h24 bg_main bdradius txtclip" style="border: 1px solid transparent" href=""><?php if( $this->inter_id == 'a472731996' ) echo '雅币'; else echo '储值';  ?>购买</a> -->
   <?php if( isset($finish_killsec) && $finish_killsec ): ?>
    ...
    <a class="h24 bg_main bdradius txtclip" style="border: 1px solid transparent" onclick='get_in_line();'>¥<?php echo $killsec['killsec_price'];?><?php 
		if($package['type'] == $packageModel::PRODUCT_TYPE_BALANCE) {
			if( $this->inter_id == 'a472731996' ) echo '雅币购买'; else echo '储值购买';
    ...
    <?php if( $is_expire ): ?>
        ...
        <div class="h24 bdradius btn_void txtclip select_type" href="<?php echo Soma_const_url::inst ()->get_package_pay(array('pid'=>$_GET['pid'],'id'=>$inter_id));?>">
            ¥<span><?php echo $package['price_package'];?></span><?php 
                if($package['type'] == $packageModel::PRODUCT_TYPE_BALANCE) {
                    if( $this->inter_id == 'a472731996' ) echo '雅币购买'; else echo '储值购买';
                } elseif($package['type'] == $packageModel::PRODUCT_TYPE_POINT) {
                    echo "积分购买";
...
$('.support_list span').click(function(){
	$.MsgBox.Confirm($(this).attr('tips'),null,null,'好的','取消');
...
$('.select_type').click(function(){
	if(specdata==''){
		...
		$.ajax({
			...
			dataType:'JSON',
			error: function(){
				$.MsgBox.Confirm('网络开小差了，请刷新重试',null,null,'好的','取消');
				$('#mb_btn_no').remove();
			},
			success: function(data){
				...
				else{ $.MsgBox.Confirm('似乎出了点问题，请稍后重试',null,null,'好的','取消');}
			},
