...
class PMS_Adapter implements IPMS{
	...
	public function get_rooms_change($rooms, $idents = array(), $condit = array()){
		 ...
		 */
		$key_date = 'lowest:' . $idents['inter_id'] . ':' . $idents['hotel_id'] . ':' . $condit['member_level'] . ':' . date('Ymd', strtotime($condit['startdate'])) . ':' . date('Ymd', strtotime($condit['enddate']));
