...
class AdminConst extends BaseConst
{
    ...
    static $oper_status = array(
        ...
        'scan_success' => 1007, // 1007：后台登录扫码成功
    );
    ...
    static $dehydrate_samples = array(
        ...
        'authority/roles/roles_list' => array(
            'keys'=>array(
                'roles_type',
                'total',
                'link'
        ...
        'authority/roles/edit_role' => array(
            'keys'=>array(
                'csrf_token',
                'csrf_value',
                'admin_type',
        ...
        'authority/roles/edit_authorities' => array(
            'keys'=>array(
                'csrf_token',
                'csrf_value',
                'role_authorities',
        ...
        'authority/roles/modules_list' => array(
            'keys'=>array(
                'csrf_token',
                'csrf_value',
                'modules',
        ...
        'authority/roles/authorities_list' => array(
            'keys'=>array(
                'csrf_token',
                'csrf_value',
                'authorities',
        ...
        'authority/roles/edit_ctrl_post' => array(
            'keys'=>array(
                'csrf_token',
                'csrf_value',
                'return_info'
        ...
        'authority/roles/edit_func_post' => array(
            'keys'=>array(
                'csrf_token',
                'csrf_value',
                'return_info'
        ...
        'authority/roles/edit_oper_post' => array(
            'keys'=>array(
                'csrf_token',
                'csrf_value',
                'return_info'
        ...
        'authority/roles/edit_role_post' => array(
            'keys'=>array(
                'csrf_token',
                'csrf_value',
                'return_info'
