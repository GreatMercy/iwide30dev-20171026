...
$db['default'] = array(
		'dsn'	=> '',
		'hostname' => '120.76.194.181', //兼容性问题，请勿用 localhost
		'database' => 'iwide30dev',
		'username' => 'iwide30dev',
...
$db[$active_group]['failover'][0]['hostname'] = '120.76.194.181'; //兼容性问题，请勿用 localhost
...
// $db[$active_group]['hostname'] = '120.76.194.181'; //兼容性问题，请勿用 localhost
// $db[$active_group]['database'] = 'iwide30dev'; //兼容性问题，请勿用 localhost
...
$db[$active_group]['hostname'] = '127.0.0.1'; //兼容性问题，请勿用 localhost
$db[$active_group]['database'] = 'iwide30dev'; //兼容性问题，请勿用 localhost
$db[$active_group]['username'] = 'root'; //兼容性问题，请勿用 localhost
$db[$active_group]['password'] = 'luguihong'; //兼容性问题，请勿用 localhost



/** ************ 多数据库连接配置 ************* **/
$db['iwide_r1'] = $db[$active_group];
$db['iwide_r1']['hostname'] = '120.76.194.181'; //兼容性问题，请勿用 localhost
$db['iwide_r1']['database'] = 'iwide30dev'; //兼容性问题，请勿用 localhost


$db['ticket_center'] = $db[$active_group];
$db['ticket_center']['hostname'] = '30.iwide.cn';    //兼容性问题，请勿用 localhost
//$db['ticket_center']['hostname'] = '10.0.0.250';    //兼容性问题，请勿用 localhost
$db['ticket_center']['database'] = 'ticket_center';
// $db['ticket_center']['username'] = 'soma';

$db['iwide_soma'] = $db[$active_group];
$db['iwide_soma']['hostname'] = '30.iwide.cn';    //兼容性问题，请勿用 localhost
//$db['iwide_soma']['hostname'] = '10.0.0.250';    //兼容性问题，请勿用 localhost
$db['iwide_soma']['database'] = 'iwide30soma';
// $db['iwide_soma']['username'] = 'soma';

$db['iwide_soma_r'] = $db['iwide_soma'];
// $db['iwide_soma_r']['hostname'] = '127.0.0.1';    //兼容性问题，请勿用 localhost
// //$db['iwide_soma']['hostname'] = '10.0.0.250';    //兼容性问题，请勿用 localhost
// $db['iwide_soma_r']['database'] = 'iwide30soma';
// $db['iwide_soma_r']['username'] = 'root';
// $db['iwide_soma_r']['password'] = 'luguihong';
