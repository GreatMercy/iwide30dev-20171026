...
class Market_interface extends CI_Controller {
	...
	public function check_order_status() {
		...
		if (! empty ( $order )) {
			...
			$info ['data'] ['extra'] ['order_time'] = $order ['order_time'];
			$info ['data'] ['extra'] ['name'] = $order ['name'];
			$info ['data'] ['extra'] ['tel'] = $order ['tel'];
			$info ['data'] ['extra'] ['roomname'] = $order ['first_detail']['roomname'];
			$info ['data'] ['extra'] ['price_code_name'] = $order ['first_detail']['price_code_name'];
