...
class Hkwxpayreturn extends MY_Controller {
    
	function hotel_payreturn() {
		$body = file_get_contents ( 'php://input' );
		$this->load->library('MYLOG');
        MYLOG::w($body,'hkwxpayreturn');
        $qf_sign = $_SERVER['HTTP_X_QF_SIGN'];
        ...
        MYLOG::w($fields_string,'hkwxpayreturn_sign');
        ...
        MYLOG::w(json_encode($_SERVER),'hkwxpayreturn_sign');
        MYLOG::w($sign,'hkwxpayreturn_sign');
