...
EOF;
	...
	public function export_list()
	{
        ...
        $select= 'shipping_id,order_id,shipping_order,shipping_fee,tracking_no,distributor,name,consumer_id,qty,create_time,reserve_date,contacts,phone,address,status,remark,openid';
        ...
        //print_r($data);die;
	    $header= array('邮寄ID','订单号', '邮寄单号', '邮寄运费', '快递单号','服务商','发货商品','sku','发货数量','邮寄申请时间','预约发货时间','收件人','收件电话','收件地址','状态','备注','购买人','联系电话');
