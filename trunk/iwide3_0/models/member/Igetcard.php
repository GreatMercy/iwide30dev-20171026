...
// 	}
	 ...
	 * @return boolean
	 */
	public function updateGcardStatus($openid, $code, $status, $outer_id=null, $is_give_by_friend=null, $friend_user_name=null, $old_user_card_code=null,$inter_id = 0)
	{
		...
		return $this->CI->pmsa->updateGcardStatus ($openid, $code, $status, $outer_id , $is_give_by_friend, $friend_user_name , $old_user_card_code );
		//return $cards;
	 ...
	 * @return boolean
	 */
	public function updateGcardStatusForPms($openid, $code, $status, $outer_id=null, $is_give_by_friend=null, $friend_user_name=null, $old_user_card_code=null)
	{
