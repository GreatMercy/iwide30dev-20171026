...
,
    ...
    public function getPublicsById($admin_id,$inter_id){
        ...
        $this->db->select('publics');
        $this->db->where('admin_id',$admin_id);
        $this->db->where('inter_id',$inter_id);
        $res = $this->db->get ('iwide_core_admin')->row_array ();
    ...
    function check_publics_runstatus($publics,$check_type=''){
    	...
    	$this->db->select('inter_id,name,run_status,arrearage_money,stop_service_time');
    	$this->db->where_in('inter_id',$publics);
    	isset($check_types[$check_type]) and $this->db->where_in('run_status',$check_types[$check_type]);
    	$data=$this->db->get('publics')->result_array();
    	if (!empty($data)){
